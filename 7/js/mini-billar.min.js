...
(function (MiniBillar) {
    class GameManager {
        ...
        static exitLobby() {
            Communication.CommunicationManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_PLAYER_QUIT_LOBBY, data: null });
            GameManager.enterSplash();
        }
        ...
        static setBilliardConstants() {
            ...
            let pocket = { id: 0, position: new Billiard.Vector2D(-42e3 - MiniBillar.GameConstants.POCKET_RADIUS / 4, -21e3 - MiniBillar.GameConstants.POCKET_RADIUS / 4), dropPosition: new Billiard.Vector2D(-42840 - MiniBillar.GameConstants.POCKET_RADIUS / 2, -21840 - MiniBillar.GameConstants.POCKET_RADIUS / 4) };
            MiniBillar.GameVars.pocketArray.push(pocket);
            pocket = { id: 1, position: new Billiard.Vector2D(0, -21e3 - MiniBillar.GameConstants.POCKET_RADIUS), dropPosition: new Billiard.Vector2D(0, -21420 - MiniBillar.GameConstants.POCKET_RADIUS) };
            MiniBillar.GameVars.pocketArray.push(pocket);
            pocket = { id: 2, position: new Billiard.Vector2D(42e3 + MiniBillar.GameConstants.POCKET_RADIUS / 4, -21e3 - MiniBillar.GameConstants.POCKET_RADIUS / 4), dropPosition: new Billiard.Vector2D(42840 + MiniBillar.GameConstants.POCKET_RADIUS / 2, -21840 - MiniBillar.GameConstants.POCKET_RADIUS / 4) };
            MiniBillar.GameVars.pocketArray.push(pocket);
            pocket = { id: 3, position: new Billiard.Vector2D(-42e3 - MiniBillar.GameConstants.POCKET_RADIUS / 4, 21e3 + MiniBillar.GameConstants.POCKET_RADIUS / 4), dropPosition: new Billiard.Vector2D(-42840 - MiniBillar.GameConstants.POCKET_RADIUS / 2, 21840 + MiniBillar.GameConstants.POCKET_RADIUS / 4) };
            MiniBillar.GameVars.pocketArray.push(pocket);
            pocket = { id: 4, position: new Billiard.Vector2D(0, 21e3 + MiniBillar.GameConstants.POCKET_RADIUS), dropPosition: new Billiard.Vector2D(0, 21420 + MiniBillar.GameConstants.POCKET_RADIUS) };
            MiniBillar.GameVars.pocketArray.push(pocket);
            pocket = { id: 5, position: new Billiard.Vector2D(42e3 + MiniBillar.GameConstants.POCKET_RADIUS / 4, 21e3 + MiniBillar.GameConstants.POCKET_RADIUS / 4), dropPosition: new Billiard.Vector2D(42840 + MiniBillar.GameConstants.POCKET_RADIUS / 2, 21840 + MiniBillar.GameConstants.POCKET_RADIUS / 4) };
            MiniBillar.GameVars.pocketArray.push(pocket);
            ...
            for (let c of this.cardsJSONData) {
                if (MiniBillar.GameVars.gameData.statistics.rewards.cards.filter(x => x.cardName === (c.id)).length < 1) {
                    if (MiniBillar.Game.currentInstance.cache.getFrameByName("texture_atlas_5", c.id + ".png")) {
                        ...
                        MiniBillar.GameVars.gameData.statistics.rewards.cards.push({ cardName: c.id, cardPoints: 0 });
                    }
                }
            }
        }
        static populateCardDatabase() {
            for (let c of this.cardsJSONData) {
                ...
                if (MiniBillar.Game.currentInstance.cache.getFrameByName("texture_atlas_5", cardIdFromJSON + ".png")) {
                    ...
                    MiniBillar.GameVars.gameData.statistics.rewards.cards.push({ cardName: cardIdFromJSON, cardPoints: 0 });
                }
                else {
...
(function (MiniBillar) {
    class EquipmentState extends Phaser.State {
        ...
        create() {
            ...
            buttonBack.onInputOut.add(function () { buttonBack.scale.set(MiniBillar.GameVars.scaleXMult, MiniBillar.GameVars.scaleYMult); }, this);
...
(function (MiniBillar) {
    class LobbyState extends Phaser.State {
        ...
        create() {
            ...
            this.buttonBack.onInputOut.add(function () { this.buttonBack.scale.set(MiniBillar.GameVars.scaleXMult, MiniBillar.GameVars.scaleYMult); }, this);
            ...
            this.titleLabel = new Phaser.Text(this.game, MiniBillar.GameVars.gameWidth / 2, 420, "WAITING FOR A RIVAL", { font: "30px Oswald-DemiBold", fontWeight: "600", fill: "#e7f6f8", align: "center" });
            ...
            this.playerNick = new Phaser.Text(this.game, MiniBillar.GameVars.gameWidth / 2 - 150, 340, "", { font: "26px Oswald-DemiBold", fontWeight: "600", fill: "#e7f6f8", align: "center" });
            ...
            this.adversaryNick = new Phaser.Text(this.game, MiniBillar.GameVars.gameWidth / 2 + 150, 340, "", { font: "26px Oswald-DemiBold", fontWeight: "600", fill: "#e7f6f8", align: "center" });
            ...
            if (MiniBillar.GameConstants.LOG_SERVER_INFO) {
                this.roomIdLabel = new Phaser.Text(this.game, MiniBillar.GameVars.gameWidth / 2, 120, "", { font: "20px Oswald-DemiBold", fontWeight: "600", fill: "#e7f6f8", align: "center" });
        ...
        setPlayers() {
            ...
            darkLayer.alpha = .7;
            const matchedLabel = this.add.text(MiniBillar.GameVars.gameWidth / 2, 400, "MATCHED, GAME STARTS!", { font: "50px Oswald-DemiBold", fill: "#E5FFFF" });
...
(function (MiniBillar) {
    class AvatarFullBodyContainer extends Phaser.Group {
        constructor(game) {
            ...
            if (this.game.device.touch) {
                this.fakeNameInput = new Phaser.Text(this.game, -105, -this.fullBodyAvatar.height - 45, this.lastValidPlayerName, { font: "30px Oswald-Medium", fill: "#E5FFFF" });
...
(function (MiniBillar) {
    class CueBallObject extends MiniBillar.BallObject {
        ...
        static changePosition(x, y) {
            ...
            return { x: newX * MiniBillar.GameConstants.PHYS_SCALE, y: newY * MiniBillar.GameConstants.PHYS_SCALE };
        }
...
(function (MiniBillar) {
    class ForceSettingContainer extends Phaser.Group {
        ...
        hide() {
            ...
            this.game.add.tween(this)
                .to({ x: this.x - (100 * (MiniBillar.GameVars.gameData.powerBarSide === MiniBillar.GameConstants.LEFT ? 1 : -1)) }, 200, Phaser.Easing.Cubic.In, true, 100);
        ...
        reset() {
            ...
            this.cue.y = 0;
            this.game.add.tween(this)
                .to({ x: MiniBillar.GameVars.gameData.powerBarSide === MiniBillar.GameConstants.LEFT ? 0 : MiniBillar.GameVars.gameWidth }, 200, Phaser.Easing.Cubic.Out, true);
            this.disable();
        }
        onDownPowerBarEmpty() {
            if (MiniBillar.StageContainer.currentInstance.selectPockets.canSelect) {
    ...
    class GUI extends Phaser.Group {
        constructor(game) {
            ...
            if (MiniBillar.GameConstants.SHOW_DEV_BUTTONS_ON_SOLO && MiniBillar.GameVars.gameMode === MiniBillar.GameConstants.SOLO_MODE) {
                ...
                this.chatButton.onInputOut.add(function () { this.chatButton.scale.set(MiniBillar.GameVars.scaleXMult, MiniBillar.GameVars.scaleYMult); }, this);
            ...
            pauseButton.onInputOut.add(function () { pauseButton.scale.set(MiniBillar.GameVars.scaleXMult, MiniBillar.GameVars.scaleYMult); }, this);
    ...
    class AvatarBubble extends Phaser.Group {
        ...
        hideTimer(skipTween = false, timeout) {
            ...
            if (skipTween) {
                ...
                this.game.add.tween(this.timerSprite.scale).to({ x: 1.2, y: 1.2 }, 150, Phaser.Easing.Quadratic.Out, true)
                    .onComplete.add(function () {
                    this.game.add.tween(this.timerSprite.scale).to({ x: .5, y: .5 }, 750, Phaser.Easing.Quadratic.In, true)
                        .onComplete.add(function () {
                        this.timerSprite.visible = false;
                    }, this);
                }, this);
...
(function (MiniBillar) {
    class HUD extends Phaser.Group {
        ...
        createSoloModeHud() {
            ...
            const playerName = new Phaser.Text(this.game, -261, 58, MiniBillar.GameVars.gameData.playerData.nick, { font: "18px Oswald-Medium", fontWeight: "400", fill: "#E5FFFF" });
            ...
            this.timer = new Phaser.Text(this.game, 0, 76, MiniBillar.GameVars.timerSolo.toString(), { font: "44px Oswald-DemiBold", fontWeight: "400", fill: "#E5FFFF" });
            ...
            this.updateTimerSLabel();
            this.points = new Phaser.Text(this.game, 340, 82, MiniBillar.Utils.validNumber(MiniBillar.GameVars.playerPoints) + " pts", { font: "28px Oswald-DemiBold", fontWeight: "400", fill: "#E5FFFF" });
            ...
            this.highscoreLayer = new Phaser.Text(this.game, 340, 54, MiniBillar.Utils.validNumber(MiniBillar.GameVars.gameData.statistics.solo.highScore), { font: "21px Oswald-Medium", fontWeight: "400", fill: "#E5FFFF" });
...
(function (MiniBillar) {
    class AdversaryLeftLayer extends Phaser.Group {
        constructor(game) {
            ...
            this.add(transparentBackground);
            const text = new Phaser.Text(this.game, MiniBillar.GameVars.gameWidth * .5, 350, "ADVERSARY CONNECTION LOST", { font: "60px Oswald-DemiBold", fontWeight: "600", fill: "#EB3359" });
            text.stroke = "#673952";
        ...
        update() {
            if (!this.buttonsCreated) {
                if (this.showButtonsTimer < 0) {
                    ...
                    buttonNewRival.onInputOut.add(function () { buttonNewRival.scale.set(MiniBillar.GameVars.scaleXMult, MiniBillar.GameVars.scaleYMult); }, this);
        ...
        constructor(game, messageImageFilename, isWinner) {
            ...
            this.game.add.tween(this.avatarBubble.scale).from({ x: .1, y: .1 }, 800, Phaser.Easing.Elastic.Out, true)
                ...
                this.game.add.tween(this.messageImage.scale)
                    .to({ y: MiniBillar.GameVars.scaleYMult }, 800, Phaser.Easing.Elastic.Out, true);
            }, this);
        }
        update() {
            super.update();
    ...
    class PauseLayer extends Phaser.Group {
        constructor(game) {
            ...
            if (MiniBillar.GameVars.gameMode === MiniBillar.GameConstants.SOLO_MODE) {
                ...
                const rulesText = new Phaser.Text(this.game, 0, 160, MiniBillar.GameConstants.RULES_TEXT, { font: this.game.device.desktop ? "24px Oswald-DemiBold" : "34px Oswald-DemiBold", fontWeight: "600", fill: "#e7f6f8", align: "center", stroke: "#2f3237", strokeThickness: 3 });
...
(function (MiniBillar) {
    class RetrySoloLayer extends Phaser.Group {
        constructor(game) {
            ...
            buttonRestart.onInputOut.add(function () { buttonRestart.scale.set(MiniBillar.GameVars.scaleXMult, MiniBillar.GameVars.scaleYMult); }, this);
    ...
    class VictoryLayer extends Phaser.Group {
        constructor(game) {
            ...
            if (MiniBillar.GameVars.gameMode === MiniBillar.GameConstants.SOLO_MODE) {
                ...
                this.buttonRestart.onInputOut.add(function () { this.buttonRestart.scale.set(MiniBillar.GameVars.scaleXMult, MiniBillar.GameVars.scaleYMult); }, this);
                ...
                this.buttonNewRival.onInputOut.add(function () { this.buttonNewRival.scale.set(MiniBillar.GameVars.scaleXMult, MiniBillar.GameVars.scaleYMult); }, this);
                ...
                if (this.animStarBox) {
                    ...
                    this.animStarBox.giftBox.boxOpeningTween.onComplete.add(function () {
                        ...
                        this.game.add.tween(this.buttonHome).to({ alpha: 1 }, 250, Phaser.Easing.Cubic.Out, true, 1000)
                            ...
                            pulseTween.to({ x: -1.0915 * MiniBillar.GameVars.scaleXMult, y: MiniBillar.GameVars.scaleYMult }, 300, Phaser.Easing.Linear.None, false);
                            pulseTween.to({ x: -MiniBillar.GameVars.scaleXMult, y: 1.0915 * MiniBillar.GameVars.scaleYMult }, 700, Phaser.Easing.Elastic.Out);
                            pulseTween.loop();
                            pulseTween.start();
                        }, this);
                    }, this);
...
(function (MiniBillar) {
    class MatchManager {
        ...
        static hideSpinCircleLayer(english, verticalSpin) {
            ...
            if (MiniBillar.GameVars.gameMode !== MiniBillar.GameConstants.SOLO_MODE) {
                Communication.CommunicationManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_CUE_BALL_SPIN_SET, data: { english: MiniBillar.GameVars.english, verticalSpin: MiniBillar.GameVars.verticalSpin } });
            }
        }
        ...
        static savePosition(velocity, deltaScrew, english) {
            ...
            for (let i = 0; i < MiniBillar.GameVars.ballArray.length; i++) {
                let ballData = { id: MiniBillar.GameVars.ballArray[i].id, active: MiniBillar.GameVars.ballArray[i].active, x: MiniBillar.GameVars.ballArray[i].position.x, y: MiniBillar.GameVars.ballArray[i].position.y };
        ...
        static rackBalls(rndSeed) {
            ...
            if (MiniBillar.GameVars.gameMode === MiniBillar.GameConstants.SOLO_MODE) {
                ...
                for (let i = 0; i < MiniBillar.GameVars.ballArray.length; i++) {
                    let ballData = { id: MiniBillar.GameVars.ballArray[i].id, active: true, x: MiniBillar.GameVars.ballArray[i].position.x, y: MiniBillar.GameVars.ballArray[i].position.y };
                    MiniBillar.GameVars.ballsData.push(ballData);
                }
            }
            else {
        ...
        static emoticonSelected(emoticonID) {
            if (!MiniBillar.GameVars.playersSetForPVBot) {
                Communication.CommunicationManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_EMOTICON_SELECTED, data: emoticonID });
            }
...
(function (MiniBillar) {
    class MatchManagerPVBot extends MiniBillar.MatchManager {
        ...
        static ballPocketed(ball) {
            if (ball.id === 8) {
                MiniBillar.RulesManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_BALL_8_POCKETED, data: null });
            }
        ...
        static sendSelectedPocket(pocketId) {
            if (MiniBillar.GameVars.currentTurn !== MiniBillar.GameConstants.ADVERSARY) {
                MiniBillar.RulesManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_POCKET_SELECTED, data: pocketId });
                MiniBillar.GameVars.skipShowingPocketAndCue = false;
            }
        }
        ...
        static ballsStoppedMoving(balls, firstBall, blackBallPocket) {
            ...
            MiniBillar.RulesManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_BALLS_STOPPED, data: data });
            if (MiniBillar.GameConstants.LOG_BOT_SERVER_INFO) {
                console.error("sending GameConstants.MESSAGE_TYPE_BALLS_STOPPED");
            }
        }
        static ballHasBeenShot(shotData) {
            MiniBillar.RulesManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_SHOT, data: shotData });
            if (MiniBillar.GameConstants.LOG_BOT_SERVER_INFO) {
        ...
        static cueRotated(cueRotation) {
            MiniBillar.RulesManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_CUE_ROTATION, data: cueRotation });
        }
        ...
        static startBotFiringSequence(canMoveCueBall, canPocketBlackBall, botBallsType, botWakeTime, selectPocketTimeAfterWake, shootTimeAfterWake) {
            MatchManagerPVBot.game.time.events.add(Phaser.Timer.SECOND * botWakeTime, function () {
                if (canMoveCueBall) {
                    ...
                    MiniBillar.RulesManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_CUE_BALL, data: { x: cueBallPos.x, y: cueBallPos.y } });
                }
                ...
                MatchManagerPVBot.game.time.events.add(Phaser.Timer.SECOND * selectPocketTimeAfterWake, function () {
                    if (canPocketBlackBall) {
                        MiniBillar.RulesManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_POCKET_SELECTED, data: shotData.pocket8Ball });
                    }
...
(function (MiniBillar) {
    class MatchManagerPVP extends MiniBillar.MatchManager {
        ...
        static ballPocketed(ball) {
            if (ball.id === 8) {
                Communication.CommunicationManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_BALL_8_POCKETED, data: null });
            }
            MiniBillar.PoolState.currentInstance.ballPocketed(ball.id);
        ...
        static matchOverDueToResignation(resigningPlayerSessionId) {
            Communication.CommunicationManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_RESIGN, data: MiniBillar.GameVars.gameData.playerData.sessionId });
        ...
        static sendCueBallPosition(x, y) {
            if (MiniBillar.GameVars.currentTurn !== MiniBillar.GameConstants.ADVERSARY) {
                Communication.CommunicationManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_CUE_BALL, data: { x: x, y: y } });
            }
        }
        static sendSelectedPocket(pocketId) {
            if (MiniBillar.GameVars.currentTurn !== MiniBillar.GameConstants.ADVERSARY) {
                Communication.CommunicationManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_POCKET_SELECTED, data: pocketId });
                MiniBillar.GameVars.skipShowingPocketAndCue = false;
            }
        }
        static adversaryCueBallPosition(position) {
        ...
        static cueRotated(cueRotation) {
            Communication.CommunicationManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_CUE_ROTATION, data: cueRotation });
        }
        static ballsStoppedMoving(balls, firstBall, blackBallPocket) {
            let data = {
                playerTurn: MiniBillar.GameVars.currentTurn === MiniBillar.GameConstants.PLAYER,
            ...
            Communication.CommunicationManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_BALLS_STOPPED, data: data });
            if (MiniBillar.GameConstants.LOG_SERVER_INFO) {
                console.error("sending GameConstants.MESSAGE_TYPE_BALLS_STOPPED");
            }
        }
        static ballHasBeenShot(shotData) {
            Communication.CommunicationManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_SHOT, data: shotData });
            if (MiniBillar.GameConstants.LOG_SERVER_INFO) {
                console.error("sending GameConstants.MESSAGE_TYPE_SHOT");
            }
        }
        ...
        static playerSet() {
            Communication.CommunicationManager.sendMessage({ type: MiniBillar.GameConstants.MESSAGE_TYPE_PLAYER_SET, data: null });
            if (MiniBillar.GameConstants.LOG_SERVER_INFO) {
        ...
        constructor(game, type, isPlayerTurn, opponentChoosingPocket) {
            ...
            if (MiniBillar.GameVars.gameMode !== MiniBillar.GameConstants.SOLO_MODE) {
                ...
                if (type === MiniBillar.GameConstants.NOTIFICATION_FIRST_TIME_INSTRUCTIONS) {
                    ...
                    transparentBackground.alpha = .6;
                    this.add(transparentBackground);
                    let rulesText = new Phaser.Text(this.game, 0, 160, MiniBillar.GameConstants.RULES_TEXT, { font: this.game.device.desktop ? "24px Oswald-DemiBold" : "34px Oswald-DemiBold", fontWeight: "600", fill: "#e7f6f8", align: "center", stroke: "#2f3237", strokeThickness: 3 });
                    rulesText.anchor.set(0.5, 0);
                    MiniBillar.Utils.colourRulesText(rulesText);
                    this.add(rulesText);
        ...
        showNonSOLONotification(type, isPlayerTurn, opponentChoosingPocket) {
            ...
            this.game.add.tween(turnImage)
                ...
                this.game.add.tween(turnImage)
                    ...
                    .onComplete.add(function () {
                    this.game.add.tween(turnImage).to({ x: -MiniBillar.GameVars.gameWidth - 100 }, turnImageSwipeDuration, Phaser.Easing.Exponential.In, true);
                }, this);
            }, this);
                ...
                this.game.add.tween(this.preloadCue)
                    ...
                    this.game.add.tween(this.preloadCue)
                        ...
                        this.game.add.tween(this.preloadCueBall)
                            .to({ x: (MiniBillar.GameVars.gameWidth / 2 + 50) * MiniBillar.GameVars.scaleXMultInverse }, 250, Phaser.Easing.Cubic.Out, true)
                            .onComplete.add(function () {
...
(function (MiniBillar) {
    class PreLoader extends Phaser.State {
        ...
        composeScene() {
            this.add.text(MiniBillar.GameVars.gameWidth * .5, MiniBillar.GameVars.gameHeight * .5, "ABCDEFG", { font: "30px Oswald-DemiBold", fontWeight: "400", fill: "#542200", align: "center" });
            this.add.text(MiniBillar.GameVars.gameWidth * .5, MiniBillar.GameVars.gameHeight * .5, "ABCDEFG", { font: "30px Oswald-Medium", fontWeight: "400", fill: "#542200", align: "center" });
...
(function (MiniBillar) {
    class SettingsLayer extends Phaser.Group {
        constructor(game) {
            ...
            buttonBack.scale.set(MiniBillar.GameVars.scaleXMult, MiniBillar.GameVars.scaleYMult);
            this.add(buttonBack);
            const titleLabel = new Phaser.Text(this.game, MiniBillar.GameVars.gameWidth / 2, 40, "SETTINGS", { font: "56px Oswald-DemiBold", fontWeight: "600", fill: "#e7f6f8" });
            ...
            const copyrightLabel = new Phaser.Text(this.game, MiniBillar.GameVars.gameWidth * 0.5, MiniBillar.GameVars.gameHeight - 46, "developed by RavalMatic", { font: "28px Oswald-DemiBold", fill: "#E5FFFF" });
            ...
            const versionLabel = new Phaser.Text(this.game, 30, MiniBillar.GameVars.gameHeight - 26, "v" + MiniBillar.GameConstants.VERSION, { font: "16px Arial", fill: "#E5FFFF" });
...
(function (MiniBillar) {
    class SplashState extends Phaser.State {
        ...
        create() {
            ...
            if (this.game.device.touch) {
                this.settingsButton.onInputDown.add(function () { this.settingsButton.scale.set(this.settingsButton.scale.x * 1.1, this.settingsButton.scale.y * 1.1); }, this);
            }
            this.settingsButton.onInputOver.add(function () { this.settingsButton.scale.set(this.settingsButton.scale.x * 1.1, this.settingsButton.scale.y * 1.1); }, this);
            this.settingsButton.onInputOut.add(function () { this.settingsButton.scale.set(MiniBillar.GameVars.scaleXMult, MiniBillar.GameVars.scaleYMult); }, this);
            ...
            if (this.game.device.touch) {
                pvpButton.onInputDown.add(function () { pvpButton.scale.set(pvpButton.scale.x * 1.1, pvpButton.scale.y * 1.1); }, this);
            }
            pvpButton.onInputOver.add(function () { pvpButton.scale.set(pvpButton.scale.x * 1.1, pvpButton.scale.y * 1.1); }, this);
            pvpButton.onInputOut.add(function () { pvpButton.scale.set(1); }, this);
            ...
            if (this.game.device.touch) {
                soloButton.onInputDown.add(function () { soloButton.scale.set(soloButton.scale.x * 1.1, soloButton.scale.y * 1.1); }, this);
            }
            soloButton.onInputOver.add(function () { soloButton.scale.set(soloButton.scale.x * 1.1, soloButton.scale.y * 1.1); }, this);
            soloButton.onInputOut.add(function () { soloButton.scale.set(1); }, this);
            ...
            if (this.game.device.touch) {
                buttonEquipment.onInputDown.add(function () { buttonEquipment.scale.set(buttonEquipment.scale.x * 1.1, buttonEquipment.scale.y * 1.1); }, this);
            }
            buttonEquipment.onInputOver.add(function () { buttonEquipment.scale.set(buttonEquipment.scale.x * 1.1, buttonEquipment.scale.y * 1.1); }, this);
            buttonEquipment.onInputOut.add(function () { buttonEquipment.scale.set(MiniBillar.GameVars.scaleXMult, MiniBillar.GameVars.scaleYMult); }, this);
