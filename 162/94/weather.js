...
async function showResults(value){
	...
	if(fdata.message==="city not found"){
		...
		ele.className="heady"
		ele.appendChild(document.createTextNode("Cidade Nao Encontrada"))
...
function displayData(data){
	...
	let months_year=["Janeiro","Fevereiro","Marco","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"];
	let days_week=["Domingo","Segunda","Terca","Quarta","Quinta","Sexta","Sabado"];
