...
function pushPreScale(xloc, yloc, width, settings) {
    ...
    platleft.parent = me;
    platright.parent = me;
    platleft.partner = platright;
    platright.partner = platleft;
...
function endCastleInsideFinal(xloc, last) {
    ...
    if (last) {
        ...
        text = stopper.text = [
            ...
            pushPreText({
                innerHTML: "PRESS BUTTON B<BR>TO SELECT A WORLD.",
                style: style
            }, xloc + 148, 26).object
        ];
    }
