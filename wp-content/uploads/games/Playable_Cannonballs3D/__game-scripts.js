...
LevelProgressContainer.prototype.rebuildInterface = function() {   
    ...
    if(this.orientation === LevelProgressContainer.PORTRAIT) {
        ...
        this.currentScoresText.setLocalPosition(0, this.LEVEL_PLATE_INITIAL_Y + totalStages * this.STAGE_PLATE_HEIGHT / 2 + 98, 0);
        this.bestScoreGroup.setLocalPosition(0, this.LEVEL_PLATE_INITIAL_Y + totalStages * this.STAGE_PLATE_HEIGHT / 2 + 60, 0);
    }
 ...
 * 
 * 
 * @author Igor Parada / Â©Famobi 2023
 */
