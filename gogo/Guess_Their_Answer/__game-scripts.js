...
// copyrightImage.js
var CopyrightImage = pc.createScript('copyrightImage');


CopyrightImage.prototype.initialize = function () {

};

CopyrightImage.prototype.update = function (dt) {
    this.entity.enabled = APIMediator.isCopyrightEnabled();
};
