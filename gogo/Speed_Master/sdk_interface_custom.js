...
SDK_INTERFACE_SETTINGS.version = "1.0.7";
	...
	return new Promise(function(resolve, reject) {
		...
		switch(event) {
			...
			case "EVENT_LEVELFAIL":
				SDK_INTERFACE_HELPERS.isGameplay = false;
			...
			case "EVENT_LEVELSTART":
				...
				SDK_INTERFACE_HELPERS.isGameplay = true;
				break;

			case "EVENT_LEVELRESTART":
				if(SDK_INTERFACE_HELPERS.isGameplay === true) {
					SDK_INTERFACE_HELPERS.GameSnacks.game.gameOver();
				}
