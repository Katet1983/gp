...
SDK_INTERFACE_SETTINGS.version = "1.1.8";
	...
	return new Promise(function(resolve, reject) {
		...
		switch(event) {
			...
			case "EVENT_LEVELSUCCESS":
				[levelType, levelName] = params.levelName.split("_");
				level = parseInt(levelName) + (levelType === "SCORE" ? 1 : 901);
				
				SDK_INTERFACE_HELPERS.GameSnacks.game.levelComplete(level);
				break;
