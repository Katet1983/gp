	...
	return new Promise(function(resolve, reject) {
		...
		const onSDKLoaded = function() {
			...
			window.famobi.localStorage = {
				...
				setItem: function(key, value) {
					if(this.isAncient) {
						SDK_INTERFACE_HELPERS.GameSnacks.storage.setItem(window.famobi_gameID + ":" + key, value);
					}
				...
				getItem: function(key) {
					if(this.isAncient) {
						return SDK_INTERFACE_HELPERS.GameSnacks.storage.getItem(window.famobi_gameID + ":" + key);
					}
				...
				removeItem: function(key) {
					if(this.isAncient) {
						SDK_INTERFACE_HELPERS.GameSnacks.storage.removeItem(window.famobi_gameID + ":" + key);
					}
