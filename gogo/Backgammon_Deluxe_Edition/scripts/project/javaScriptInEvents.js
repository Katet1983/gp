...
const scriptsInEvents = {
	...
	async Splashes_Event3_Act3(runtime, localVars)
	{
		runtime.globalVars.SOUND_ON = GameSnacks.audio.isEnabled()
	},

	async Gamesnacks_es_Event5_Act4(runtime, localVars)
	{
	...
	async Gamesnacks_es_Event44_Act1(runtime, localVars)
	{
		GameSnacks.ad.break({
	...
	async Gamesnacks_es_Event45_Act2(runtime, localVars)
	{
	...
	async Gamesnacks_es_Event54_Act1(runtime, localVars)
	{
	...
	async Gamesnacks_es_Event56_Act1(runtime, localVars)
	{
		GameSnacks.game.ready();
	},

	async Gamesnacks_es_Event59_Act2(runtime, localVars)
	{
	...
	async Gamesnacks_es_Event77_Act1(runtime, localVars)
	{
		GameSnacks.storage.setItem(localVars.item, localVars.value);
	},

	async Gamesnacks_es_Event78_Act1(runtime, localVars)
	{
		GameSnacks.storage.removeItem(localVars.item);
	},

	async Gamesnacks_es_Event81_Act1(runtime, localVars)
	{
window.GameSnacks = {
  ad: {
    break(o) {
...
//   }
  ...
  storage: {
	...
	async Gamees_Event17_Act1(runtime, localVars)
	{
		runtime.globalVars.board = new Board(runtime);
		runtime.globalVars.board.startNextGame(false, false,false, runtime.globalVars.level);
	},

	async Gamees_Event18_Act3(runtime, localVars)
	{
		runtime.globalVars.board = new Board(runtime);
		runtime.globalVars.board.startNextGame(false, true,false, runtime.globalVars.level);
	},

	async Gamees_Event221_Act1(runtime, localVars)
	{
		runtime.globalVars.board.undoLastTest();
	},

	async Gamees_Event223_Act1(runtime, localVars)
	{
		runtime.globalVars.board.prepareNextTurn();
	},

	async Gamees_Event232_Act13(runtime, localVars)
	{
		runtime.globalVars.board.startNextTurnStep();
		
	},

	async Gamees_Event269_Act2(runtime, localVars)
	{
		runtime.globalVars.board.undoLastPlayedStep();
	},

	async Gamees_Event270_Act1(runtime, localVars)
	{
		runtime.globalVars.board.pointTouched(localVars.colIndex);
	},

	async Gamees_Event272_Act1(runtime, localVars)
	{
		runtime.globalVars.board.pieceTouched(localVars.pieceIndex);
	},

	async Gamees_Event293_Act4(runtime, localVars)
	{
		runtime.globalVars.board.prepareDices();
	},

	async Gamees_Event348_Act5(runtime, localVars)
	{
		runtime.globalVars.board.computerFinishedTurn();
	},

	async Mainsplashes_Event1_Act2(runtime, localVars)
	{
	...
	async Mainsplashes_Event1_Act3(runtime, localVars)
	{
