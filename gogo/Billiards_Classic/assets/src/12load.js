...
loadState.init = function(){
	...
	loaderInfo.loadPanel = new Phaser.Sprite(game, 0, 0, 'loadPanel');
	loaderInfo.loaderCanvas.addChild(loaderInfo.loadPanel);
	loaderInfo.loadPanel.anchor = new Point(.5, .5);
...
loadState.resizeGame = function(scale, bounds){ 
		...
		// console.log(loaderInfo.loaderCanvas);

		loaderInfo.loaderCanvas.x = game.width / 2;
		loaderInfo.loaderCanvas.y = game.height / 2;
		//loaderInfo.bgL.x = 0;
		//loaderInfo.bgL.y = 0;
		loaderInfo.loaderBase.y = 300;
		loaderInfo.loaderFill.y = 300;
		loaderInfo.loaderHighlight.y = 300;
		
		//loaderInfo.loadPanel.y = (game.height / 2);
...
loadState.preload = function(){
	...
	this.load.spritesheet('muteButton', 'assets/img/muteButton.png', 154, 154);
	this.load.spritesheet('playButton', 'assets/img/playButton.png', 232, 233);
	this.load.spritesheet('playButtonSmall', 'assets/img/playButtonSmall.png', 154, 154);
	this.load.spritesheet('quitButton', 'assets/img/quitButton.png', 183, 183);
	this.load.spritesheet('replayButton', 'assets/img/replayButton.png', 154, 154);
	this.load.spritesheet('helpButton', 'assets/img/helpButton.png', 154, 154);
	...
	this.load.spritesheet('guideButton', 'assets/img/guideButton.png', 154, 154);
	this.load.spritesheet('aiButton', 'assets/img/aiLevel.png', 154, 154);

	//this.load.spritesheet('creditsButton', 'assets/img/creditsButton.png', 100, 100);
	this.load.spritesheet('menuButton', 'assets/img/menuButton.png', 88, 88);
	...
	game.load.bitmapFont('font7', 'assets/fonts/font7.png', 'assets/fonts/font7.fnt');
	...
	this.load.image('panel4', 'assets/img/panel4b.png');
	...
	this.load.image('humanIcon', 'assets/img/humanIcon.png');
	this.load.image('aiIcon', 'assets/img/aiIcon.png');
	this.load.image('turnArrow', 'assets/img/turnArrow.png');
