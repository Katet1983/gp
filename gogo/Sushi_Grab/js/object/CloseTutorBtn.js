...
game.object.CloseTutorBtn = me.GUI_Object.extend({
	init: function(x, y, settings = {}){
		...
		settings.framewidth = settings.framewidth || 55;
		...
		this.addAnimation('idle', [{ name: "close", delay: 100 }]);
		this.setCurrentAnimation('idle');
		this.var = {};

        // Put user code here //
        impose(settings, "func", function(){});
        impose(settings, "scaleX", 1.01);
        impose(settings, "scaleY", 1.01);
