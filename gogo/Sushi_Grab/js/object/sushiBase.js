...
game.object.sushiBase = me.Sprite.extend({
	init: function(x, y, settings = {}){
        ...
        this.gotgrab = false;
        this.susitipe = settings.region;
        
        this.getSushiEvent = me.event.subscribe("GetSushiEvent", this.GetSushi.bind(this));
        this.particleEvent = me.event.subscribe("ParticleEvent", this.ShowParticle.bind(this));
        //  End of user code  //
	},
	...
	update: function(dt){
        ...
        if(this.jalankanan){
            ...
            if(this.pos.x >= me.game.viewport.width/2+520){
	...
	onDeactivateEvent : function() {
        ...
        // Put user code here //
        me.event.unsubscribe(this.getSushiEvent);
        me.event.unsubscribe(this.particleEvent);
        //  End of user code  //
	},

    // Put user code here //
    GetSushi : function(){
        this.container.sushiOnPlay.push(this);
    },
    
    ShowParticle : function(){
        this.particle = me.pool.pull("particle1", this.pos.x
                                                , this.pos.y);
        me.game.world.addChild(this.particle, this.pos.z + 1);
        this.particle.setCurrentAnimation("Animation 1", function(){
            me.game.world.removeChild(this.particle);
        }.bind(this));
    },
    //  End of user code  //
});
