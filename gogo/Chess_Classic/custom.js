window.GAMESNACKS = {
	...
	levelComplete: function(level) {
		try {
			window.GameSnacks.game.levelComplete();
		} catch(e) {
			console.warn(e);
		}
	}
...
window.famobi.localStorage = {
	setItem: function(key, value) {
		window.GameSnacks.storage.setItem(window.famobi_gameID + ":" + key, value);
	},
	getItem: function(key) {
		return window.GameSnacks.storage.getItem(window.famobi_gameID + ":" + key);
	},
	removeItem: function(key) {
		window.GameSnacks.storage.removeItem(window.famobi_gameID + ":" + key);
	},
	clear: function() {
