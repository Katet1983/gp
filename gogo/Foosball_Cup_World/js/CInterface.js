function CInterface(){
    ...
    this._init = function(){  
        ...
        var oSprite = s_oSpriteLibrary.getSprite('but_exit');
         _pStartPosExit = {x: CANVAS_WIDTH - (oSprite.height/2)- 10 - 50, y: (oSprite.height/2) + 10};
        _oButExit = new CGfxButton(_pStartPosExit.x, _pStartPosExit.y, oSprite,_oContainer);
        _oButExit.addEventListener(ON_MOUSE_UP, this._onExit, this);
        
        oExitX = CANVAS_WIDTH - (oSprite.width/2) - 140;
        _pStartPosPause = {x: oExitX - 50, y: (oSprite.height/2) + 10};
        ...
        _oButPause.addEventListener(ON_MOUSE_UP,() => handlePause(),this);
        ...
        _pStartPosAudio = {x: _pStartPosPause.x-oSprite.height-10,y: _pStartPosPause.y};

        // console.log(_oContainer)
        ...
        _pStartPosButHelp = {x:oSprite.width/4+10 + 50,y:oSprite.height/2+10};
    ...
    this.initMobileButtons = function(){
        ...
        if (!s_b2Players){
            _pStartPosButUpP1 = {x: CANVAS_WIDTH/2-800, y: CANVAS_HEIGHT/2+100};
            ...
            _pStartPosButUpP1 = {x: CANVAS_WIDTH/2-800, y: CANVAS_HEIGHT/2+100};
            _pStartPosButDownP1 = {x: CANVAS_WIDTH/2-800, y: CANVAS_HEIGHT/2+350};
            _pStartPosButUpP2 = {x: CANVAS_WIDTH/2+800, y: CANVAS_HEIGHT/2+100};
    ...
    this._onFullscreenRelease = function(){
        trace("s_bFullscreen "+s_bFullscreen)
	if(s_bFullscreen) { 
