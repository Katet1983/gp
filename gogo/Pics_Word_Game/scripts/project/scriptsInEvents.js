...
const scriptsInEvents = {
	...
	async E_gameplay_Event107_Act1(runtime, localVars)
	{
		GameSnacks.game.gameOver();
	},

	async E_gameplay_Event108_Act1(runtime, localVars)
	{
		crazysdk.gameplayStop();
	},

	async E_gameplay_Event161_Act1(runtime, localVars)
	{
		GameSnacks.game.onPause();
	},

	async E_gameplay_Event163_Act1(runtime, localVars)
	{
		htmlAds(runtime.globalVars.adtype2,runtime)
	},

	async E_gameplay_Event163_Act2(runtime, localVars)
	{
		GameSnacks.game.onResume();
	},

	async E_gameplay_Event183_Act1(runtime, localVars)
	{
		GameSnacks.game.gameOver();
	},

	async E_gameplay_Event184_Act1(runtime, localVars)
	{
		crazysdk.gameplayStop();
	},
	...
	async EventSheet1_Event67_Act1(runtime, localVars)
	{
		crazysdk.gameplayStop();
	},

	async EventSheet1_Event106_Act1(runtime, localVars)
	{
		crazysdk.gameplayStart();
	},
	...
	async Function_Event99_Act8(runtime, localVars)
	{
		htmlAds(runtime.globalVars.adtype,runtime)
	},

	async Function_Event170_Act4(runtime, localVars)
	{
		await crazysdk.displayAd("midgame");
	},

	async Function_Event173_Act4(runtime, localVars)
	{
		await crazysdk.displayAd("rewarded");
	},

	async Function_Event176_Act2(runtime, localVars)
	{
		var jsonString = runtime.globalVars.ajaxData;
		GameSnacks.storage.setItem('fourpicgameuserdata',jsonString);
	},

	async Function_Event178_Act1(runtime, localVars)
	{
		let starsEarned =(GameSnacks.storage.getItem('fourpicgameuserdata'));
		runtime.globalVars.Datastring = starsEarned;
	},

	async E_levelcomplate_Event4_Act1(runtime, localVars)
	{
		GameSnacks.score.update(runtime.globalVars.levelno+99);
		GameSnacks.game.levelComplete(runtime.globalVars.levelno-1);
	},

	async E_levelcomplate_Event50_Act2(runtime, localVars)
	{
		crazysdk.gameplayStop();
	},
	...
	async E_main_Event4_Act3(runtime, localVars)
	{
		gameLoop(runtime)
	},

	async E_main_Event5_Act1(runtime, localVars)
	{
		GameSnacks.game.ready();
	},

	async E_main_Event5_Act3(runtime, localVars)
	{
		gameLoop(runtime)
	},

	async E_giftrewards_Event37_Act1(runtime, localVars)
	{
		console.log("suspended...")
	},

	async E_giftrewards_Event38_Act1(runtime, localVars)
	{
		console.log("resume...")
	},

	async E_gameloading_Event1_Act6(runtime, localVars)
	{
		crazysdk.gameplayStart();
	}
