...
R.Card.prototype.open = function(isOpen, isAnim)
{
    ...
    else this.loadTexture(isOpen ? this.cardData.name : 'card_skin1');
};
...
R.moveSaver = {
    ...
    undo: function()
    {
        ...
        if(this.column)
        {
            ...
            if(this.isColumnNotMoved && (!this.card.prevOwner || this.card.prevOwner === R.deck.srcOpen)) R.scoreChange(-5);
        }
