...
R.OptionsScreen = function()
{
    ...
    var homeButton = game.add.button(0, 0, 'gui', this.onHomeButton, this, 'home_button', 'home_button', 'home_button_pushed', 'home_button');
...
{
    window.famobi_analytics.trackEvent("EVENT_LEVELFAIL", {levelName: R.deck.mode.toString(), reason: "draw"}).then(
        function() {
            this.enableButtons(false);
