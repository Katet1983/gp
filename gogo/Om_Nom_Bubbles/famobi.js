...
window.famobi_gameID = "om-nom-bubbles";
window.famobi_gameJS = ["bubblewoods-min.js",
	function () {
		window.BubbleWoods.init(window.famobi.getCurrentLanguage());
	}
];

const _loadSnippet = function() {
