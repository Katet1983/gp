			...
			window.famobi.localStorage = {
				...
				init: function() {
					return new Promise(resolve => {
						try {
							this.savegame = JSON.parse(SDK_INTERFACE_HELPERS.GameSnacks.storage.getItem(this.key) || "{}");
						} catch(e) {
							this.savegame = {};
						}
						
						if(window.famobi_gameID === "smarty-bubbles-2") {
							this.savegame["SmartyBubbles2"] = this.savegame["SmartyBubbles2"] || "{}";
							try{
								let parsed = JSON.parse(this.savegame["SmartyBubbles2"]) || {};
								parsed["version"] = parsed["version"] || 1;
								parsed["highscore"] = parsed["highscore"] || 0;
								parsed["level"] = parsed["level"] || 1;
								parsed["sound"] = typeof parsed["sound"] !== "undefined" ? parsed["sound"] : true;
