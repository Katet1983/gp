...
if (typeof window !== "undefined" && !window.famobi) {
        ...
        var famobi = {
                ...
                menu: {
                    create: function() {
                        ...
                        if(false && window.famobi.config.supportedLanguages && window.famobi.config.supportedLanguages.length > 1) {
    ...
    Promise.all([loadScript("sdk_interface.js"), isPageReady]).then(function() {
        ...
        Promise.all((window.famobi.config.ads && !!window.famobi.config.ads.show_initial) ? [window.famobi.showInterstitialAd("preroll")] : []).then(function() {
            setTimeout(function() {
                (function next() {
