...
SDK_INTERFACE_SETTINGS.version = "1.1.4";
	...
	return new Promise(function(resolve, reject) {
		...
		switch(event) {
			...
			case "EVENT_LEVELFAIL":
				if(params.reason === "quit" && lastFamobiAnalyticsEvent === "EVENT_LEVELSUCCESS" && ["color-pixel-art-classic"].includes(window.famobi_gameID)) {
					break;
				}
				SDK_INTERFACE_HELPERS.GameSnacks.game.gameOver();
				break;
