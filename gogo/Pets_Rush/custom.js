	...
	return new Promise(function(resolve, reject) {
		switch(event) {
			...
			case "EVENT_LEVELFAIL":
				...
				GAMESNACKS.gameOver();
				window.famobi_analytics.currentScreen = "SCREEN_LEVELRESULT";
				return resolve(event, params);
...
window.famobi_analytics.trackScreen = function(screen, pageTitle) {
	return new Promise(function(resolve, reject) {

		if((screen == "SCREEN_HOME") && (window.famobi_analytics.currentScreen == "SCREEN_PAUSE" || window.famobi_analytics.currentScreen == "SCREEN_LEVEL")) {
			console.log("GAMESNACKS.gameOver");
			GAMESNACKS.gameOver();
		}

		window.famobi_analytics.currentScreen = screen;
		window.famobi_analytics.pageTitle = pageTitle;
