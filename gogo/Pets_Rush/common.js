...
var adDurationIntervall = null;
if (typeof window !== "undefined" && !window["famobi"]){
	!function(a, b) {
		var famobi = {
			// ... advertising will show up every 30-90 seconds ...
			showAd: function(callback) {
                ...
                clearInterval(adDurationIntervall);

                adDurationIntervall = setInterval(function() {
                	console.log(secondsAdDuration);
                	secondsAdDuration--;

                	if(secondsAdDuration <= 0) {
	...
	!function(a, b) {
		var famobi_analytics = {
			...
			'trackStats': function(key, value) {
				...
				famobi.log("trackStats():", key, value);
