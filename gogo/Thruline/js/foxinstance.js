var foxinstance = foxinstance || {};

foxinstance = function (x, y, params) {
    ...
    if (this['name'] === undefined) {
        fox.alert('WARNING : foxinstance has no name!');
        // uncomment below to find the source of the problem
        throw new Error('foxinstance has no name!');
    }
...
foxinstance.prototype = Object.create(PIXI.Container.prototype);
foxinstance.prototype.constructor = foxinstance;

foxinstance.prototype.begin = function () {
    this.spawn();
};
foxinstance.prototype.spawn = function () {};
foxinstance.prototype.loop = function () {};

// setup act
foxinstance.prototype.setupact = function (newact) {
    // first, disable all acts
    this.disableacts();
    if (newact in g.foxclip) {
        this.acttype[newact] = "foxclip";
        let it = fox.attachclip(newact, 0, 0, this, {heaven:this.heaven});
        ...
        this.actgo = it;
        this.addChild(it);
    } else if (typeof window[newact] === 'function') {
        this.acttype[newact] = "function";
        let it = fox.make(newact, 0, 0, this);
        this.actdict[newact] = it;
        this._act = newact;
        this.actgo = it;
        this.addChild(it);
...
// switch act
foxinstance.prototype.switchact = function (newact) {
...
// disable acts
foxinstance.prototype.disableacts = function () {
...
foxinstance.prototype.resetact = function () {
    this._act = "";
};

// kill
foxinstance.prototype.kill = function (delay = 0, killchildren = true) {
    if (delay !== 0) {
        // delayed kill
