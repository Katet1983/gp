...
SDK_INTERFACE_SETTINGS.version = "1.0.9";
		...
		*/
		...
		if(typeof params.eventId === "string") {
			switch(params.eventId.toLowerCase()) {
				...
				case "button:start":
				case "button:choosejumpstarter:start":
