...
(lib.clear_a = function() {
	this.initialize(img.clear_a);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,90,110);


(lib.clear_c = function() {
	this.initialize(img.clear_c);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,82,113);


(lib.clear_e = function() {
	this.initialize(img.clear_e);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,72,110);


(lib.clear_l = function() {
	this.initialize(img.clear_l);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,70,110);


(lib.clear_r = function() {
	this.initialize(img.clear_r);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,82,110);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFCC66").s().p("Ag1CZIAAkxIBrAAIAAExg");
...
if (reversed == null) { reversed = false; }
	...
	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ag1CZIAAkxIBqAAIAAExg");
...
if (reversed == null) { reversed = false; }
	...
	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF6666").s().p("Ag1CZIAAkxIBrAAIAAExg");
	this.shape.setTransform(5.35,15.325);
...
if (reversed == null) { reversed = false; }
	...
	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF96A6").s().p("Ag1CZIAAkxIBrAAIAAExg");
	this.shape.setTransform(5.35,15.325);
...
if (reversed == null) { reversed = false; }
	...
	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#2BA47D").s().p("Ag1CZIAAkxIBrAAIAAExg");
	this.shape.setTransform(5.35,15.325);
...
(lib.clear_r_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// レイヤー_1
	this.instance = new lib.clear_r();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.clear_r_1, new cjs.Rectangle(0,0,82,110), null);


(lib.clear_l_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// レイヤー_1
	this.instance = new lib.clear_l();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.clear_l_1, new cjs.Rectangle(0,0,70,110), null);


(lib.clear_e_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// レイヤー_1
	this.instance = new lib.clear_e();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.clear_e_1, new cjs.Rectangle(0,0,72,110), null);


(lib.clear_c_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// レイヤー_1
	this.instance = new lib.clear_c();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.clear_c_1, new cjs.Rectangle(0,0,82,113), null);


(lib.clear_a_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// レイヤー_1
	this.instance = new lib.clear_a();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.clear_a_1, new cjs.Rectangle(0,0,90,110), null);
...
if (reversed == null) { reversed = false; }
	...
	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#3399FF").s().p("Ag1CZIAAkxIBrAAIAAExg");
	this.shape.setTransform(5.35,15.325);
...
if (reversed == null) { reversed = false; }
	...
	// レイヤー_3
	this.instance = new lib.green();
	this.instance.setTransform(-92.95,390,1,1,29.9992,0,0,5.8,14.9);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({_off:false},0).wait(1).to({regX:5.3,regY:15.3,rotation:43.9302,x:114.35,y:226.55},0).wait(1).to({rotation:57.8613,x:171.1,y:194.3},0).wait(1).to({rotation:71.7923,x:210.3,y:175.75},0).wait(1).to({rotation:85.7233,x:240.9,y:163.7},0).wait(1).to({rotation:99.6543,x:266.1,y:155.6},0).wait(1).to({rotation:113.5854,x:287.65,y:150.3},0).wait(1).to({rotation:127.5164,x:306.25,y:147},0).wait(1).to({rotation:141.4474,x:322.8,y:145.25},0).wait(1).to({rotation:155.3784,x:337.6,y:144.7},0).wait(1).to({rotation:169.3095,x:350.8,y:145.25},0).wait(1).to({rotation:183.2405,x:362.75,y:146.65},0).wait(1).to({rotation:197.1715,x:373.65,y:148.8},0).wait(1).to({rotation:211.1026,x:383.6,y:151.55},0).wait(1).to({rotation:225.0336,x:392.7,y:154.85},0).wait(1).to({rotation:238.9646,x:400.95,y:158.6},0).wait(1).to({rotation:252.8956,x:408.55,y:162.8},0).wait(1).to({rotation:266.8267,x:415.6,y:167.35},0).wait(1).to({rotation:280.7577,x:422,y:172.2},0).wait(1).to({rotation:294.6887,x:427.9,y:177.35},0).wait(1).to({rotation:308.6198,x:433.35,y:182.7},0).wait(1).to({rotation:322.5508,x:438.4,y:188.35},0).wait(1).to({rotation:336.4818,x:443.05,y:194.15},0).wait(1).to({rotation:350.4128,x:447.4,y:200.1},0).wait(1).to({rotation:364.3439,x:451.4,y:206.3},0).wait(1).to({rotation:378.2749,x:455.1,y:212.65},0).wait(1).to({rotation:392.2059,x:458.55,y:219.15,alpha:0.75},0).wait(1).to({rotation:406.1369,x:461.7,y:225.8,alpha:0.5},0).wait(1).to({rotation:420.068,x:464.75,y:232.7,alpha:0.25},0).wait(1).to({rotation:433.999,x:467.5,y:239.65,alpha:0},0).to({_off:true},1).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// レイヤー_10
	this.instance = new lib.clear_r_1();
	this.instance.setTransform(504,247.65,1,1,0,0,0,41,55);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(25).to({_off:false},0).wait(1).to({y:251.2},0).wait(1).to({y:254.8},0).wait(1).to({y:258.4},0).wait(1).to({y:262},0).wait(1).to({y:265.6},0).wait(1).to({y:269.2},0).wait(1).to({y:272.8},0).wait(1).to({y:276.4},0).wait(1).to({y:280},0).wait(1).to({y:283.6},0).wait(1).to({y:287.2},0).wait(1).to({y:290.8},0).wait(1).to({y:294.4},0).wait(1).to({y:298},0).wait(1).to({y:301.6},0).wait(1).to({y:305.2},0).wait(1).to({y:308.8},0).wait(1).to({y:312.4},0).wait(1).to({y:316},0).wait(45));

	// レイヤー_9
	this.instance_1 = new lib.clear_a_1();
	this.instance_1.setTransform(404,247.65,1,1,0,0,0,45,55);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(19).to({_off:false},0).wait(1).to({y:250.9},0).wait(1).to({y:254.15},0).wait(1).to({y:257.4},0).wait(1).to({y:260.65},0).wait(1).to({y:263.9},0).wait(1).to({y:267.15},0).wait(1).to({y:270.4},0).wait(1).to({y:273.65},0).wait(1).to({y:276.9},0).wait(1).to({y:280.15},0).wait(1).to({y:283.45},0).wait(1).to({y:286.7},0).wait(1).to({y:289.95},0).wait(1).to({y:293.2},0).wait(1).to({y:296.45},0).wait(1).to({y:299.7},0).wait(1).to({y:302.95},0).wait(1).to({y:306.2},0).wait(1).to({y:309.45},0).wait(1).to({y:312.7},0).wait(1).to({y:316},0).wait(49));

	// レイヤー_8
	this.instance_2 = new lib.clear_e_1();
	this.instance_2.setTransform(310,247.65,1,1,0,0,0,36,55);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(13).to({_off:false},0).wait(1).to({y:250.6},0).wait(1).to({y:253.55},0).wait(1).to({y:256.55},0).wait(1).to({y:259.5},0).wait(1).to({y:262.5},0).wait(1).to({y:265.45},0).wait(1).to({y:268.45},0).wait(1).to({y:271.4},0).wait(1).to({y:274.35},0).wait(1).to({y:277.35},0).wait(1).to({y:280.3},0).wait(1).to({y:283.3},0).wait(1).to({y:286.25},0).wait(1).to({y:289.25},0).wait(1).to({y:292.2},0).wait(1).to({y:295.15},0).wait(1).to({y:298.15},0).wait(1).to({y:301.1},0).wait(1).to({y:304.1},0).wait(1).to({y:307.05},0).wait(1).to({y:310.05},0).wait(1).to({y:313},0).wait(1).to({y:316},0).wait(53));

	// レイヤー_7
	this.instance_3 = new lib.clear_l_1();
	this.instance_3.setTransform(226,246.65,1,1,0,0,0,35,55);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(7).to({_off:false},0).wait(1).to({y:249.45},0).wait(1).to({y:252.3},0).wait(1).to({y:255.15},0).wait(1).to({y:258},0).wait(1).to({y:260.85},0).wait(1).to({y:263.7},0).wait(1).to({y:266.55},0).wait(1).to({y:269.4},0).wait(1).to({y:272.25},0).wait(1).to({y:275.1},0).wait(1).to({y:277.95},0).wait(1).to({y:280.8},0).wait(1).to({y:283.65},0).wait(1).to({y:286.5},0).wait(1).to({y:289.35},0).wait(1).to({y:292.2},0).wait(1).to({y:295.05},0).wait(1).to({y:297.9},0).wait(1).to({y:300.75},0).wait(1).to({y:303.6},0).wait(1).to({y:306.45},0).wait(1).to({y:309.3},0).wait(1).to({y:312.15},0).wait(1).to({y:315},0).wait(58));

	// レイヤー_6
	this.instance_4 = new lib.clear_c_1();
	this.instance_4.setTransform(138,248.15,1,1,0,0,0,41,56.5);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({_off:false},0).wait(1).to({y:250.75},0).wait(1).to({y:253.4},0).wait(1).to({y:256},0).wait(1).to({y:258.65},0).wait(1).to({y:261.25},0).wait(1).to({y:263.9},0).wait(1).to({y:266.55},0).wait(1).to({y:269.15},0).wait(1).to({y:271.8},0).wait(1).to({y:274.4},0).wait(1).to({y:277.05},0).wait(1).to({y:279.65},0).wait(1).to({y:282.3},0).wait(1).to({y:284.95},0).wait(1).to({y:287.55},0).wait(1).to({y:290.2},0).wait(1).to({y:292.8},0).wait(1).to({y:295.45},0).wait(1).to({y:298.05},0).wait(1).to({y:300.7},0).wait(1).to({y:303.35},0).wait(1).to({y:305.95},0).wait(1).to({y:308.6},0).wait(1).to({y:311.2},0).wait(1).to({y:313.85},0).wait(1).to({y:316.5},0).wait(62));

	// レイヤー_4_コピー_コピー_コピー_コピー
	this.instance_5 = new lib.a();
	this.instance_5.setTransform(836.7,285.1,0.7675,0.7675,0,0,180,-72.7,419.3);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(31).to({_off:false},0).to({_off:true},32).wait(26));

	// レイヤー_5_コピー_コピー
	this.instance_6 = new lib.b();
	this.instance_6.setTransform(762.5,332.4,0.6667,0.6667,0,0,0,-86,413.3);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(29).to({_off:false},0).to({_off:true},34).wait(26));

	// レイヤー_4_コピー_コピー_コピー
	this.instance_7 = new lib.a();
	this.instance_7.setTransform(791.15,516.55,0.8765,0.8765,0,0,180,-72.5,419.2);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(31).to({_off:false},0).to({_off:true},32).wait(26));

	// レイヤー_4_コピー_コピー
	this.instance_8 = new lib.a();
	this.instance_8.setTransform(765.5,333.45,1,1,0,0,180,-72.5,419.2);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(29).to({_off:false},0).to({_off:true},34).wait(26));

	// レイヤー_5_コピー
	this.instance_9 = new lib.b();
	this.instance_9.setTransform(699.8,413.35,1,1,0,0,180,-86,413.4);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(29).to({_off:false},0).to({_off:true},34).wait(26));

	// レイヤー_4_コピー_コピー_コピー
	this.instance_10 = new lib.a();
	this.instance_10.setTransform(-217.3,369.65,0.7675,0.7675,0,0,0,-72.7,419.3);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(6).to({_off:false},0).to({_off:true},32).wait(51));

	// レイヤー_5_コピー
	this.instance_11 = new lib.b();
	this.instance_11.setTransform(-150.45,332.4,0.6667,0.6667,0,0,180,-86,413.3);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(4).to({_off:false},0).to({_off:true},34).wait(51));

	// レイヤー_4_コピー_コピー
	this.instance_12 = new lib.a();
	this.instance_12.setTransform(-185.95,516.55,0.8765,0.8765,0,0,0,-72.5,419.2);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(2).to({_off:false},0).to({_off:true},32).wait(55));

	// レイヤー_4_コピー
	this.instance_13 = new lib.a();
	this.instance_13.setTransform(-177.95,333.45,1,1,0,0,0,-72.5,419.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({_off:true},34).wait(55));

	// レイヤー_5
	this.instance_14 = new lib.b();
	this.instance_14.setTransform(-85.25,413.35,1,1,0,0,0,-86,413.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({_off:true},34).wait(55));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(85.4,591.7,768.7,-26.800000000000068);
// library properties:
lib.properties = {
	id: '72F85A1F0056F64398FE89FF3F898E78',
	width: 640,
	height: 800,
	fps: 60,
	color: "#CCCCCC",
	opacity: 1.00,
	manifest: [
		{src:"./effectcjs/clear/images/clear_a.png", id:"clear_a"},
		{src:"./effectcjs/clear/images/clear_c.png", id:"clear_c"},
		{src:"./effectcjs/clear/images/clear_e.png", id:"clear_e"},
		{src:"./effectcjs/clear/images/clear_l.png", id:"clear_l"},
		{src:"./effectcjs/clear/images/clear_r.png", id:"clear_r"}
	],
	preloads: []
};
...
an.compositions['72F85A1F0056F64398FE89FF3F898E78'] = {
