...
$jscomp.polyfill("String.prototype.replaceAll",function(a){return a?a:function(b,e){if(b instanceof RegExp&&!b.global)throw new TypeError("String.prototype.replaceAll called with a non-global RegExp argument.");return b instanceof RegExp?this.replace(b,e):this.replace(new RegExp(String(b).replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g,"\\$1").replace(/\x08/g,"\\x08"),"g"),e)}},"es_2021","es3");inlHelper={VERSION:"1.0.11",ads:null,game:null,rewardAds:null};
const AD_TYPES={PREROLL:"preroll",GAME_LOADED:"gameloaded",GAME_START:"gamestart",GAME_OVER:"gameover",GAMEPLAY:"gameplay",GAMEPLAY_INTERRUPTING:"gameplay_interrupting",AFK:"afk",REWARDED:"rewarded"},GAMEPLAY_ADS_LEVELS={NONE:"none",NON_INTERRUPTING:"non_interrupting",ALL:"all"},adsConfig={enabled:!1,cooldownTimer:2E4,firstAdDelay:0,gameplayAdTimer:24E4,afkTimer:0,test:!1,autoAdSuccessful:!0,enableTriggerPoints:!0,gameplayAdsLevel:GAMEPLAY_ADS_LEVELS.ALL,regularCooldownGameplayAds:!0},gameConfig=
{removeGameInit:!1,fullscreenAllowed:!0,inlLogoAllowed:!0,cheatVersion:!1,debugVersion:!1},rewAdsConfig={active:!0,test:!1};function getUrlParams(){const a={},b=window.location.search.substring(1).split("&");for(const e of b)if(e){let [f,h]=e.split("=").map(decodeURIComponent);"true"===h?h=!0:"false"===h?h=!1:isNaN(h)||""===h.trim()||(h=Number(h));a[f]=h}return a}let urlParams=getUrlParams();null!=urlParams.cheats&&(gameConfig.cheatVersion=urlParams.cheats);
...
w.style.color="#fff";w.style.border="none";w.style.padding="10px 20px";w.style.fontSize="18px";w.style.cursor="pointer";w.style.borderRadius="5px";n.appendChild(v);n.appendChild(w);h.appendChild(m);h.appendChild(k);h.appendChild(n);f.appendChild(h);document.body.appendChild(f);v.addEventListener("click",()=>{"function"===typeof a&&a.call(e);document.body.contains(f)&&document.body.removeChild(f)});w.addEventListener("click",()=>{"function"===typeof b&&b.call(e);document.body.contains(f)&&document.body.removeChild(f)})};var ANTIALIAS_ENABLED=!0,soundManager=null,screenSplash=null,screenTopPanel=null,screenGame=null,screenBackground=null,screenSettings=null,screenParticles=null,progressMap={},onProgress=function(a,b){progressMap[a]=+b;Object.keys(progressMap).reduce(function(e,f){return e+progressMap[f]},0);null!=screenSplash&&(screenSplash.txtContinue.text=b+"%")},runGame=function(){inlHelper.ads.triggerAdPoint({adType:AD_TYPES.PREROLL});Buttons.enabled=!1;engine=new BABYLON.Engine(canvas,ANTIALIAS_ENABLED,{},!0);
engine.disableUniformBuffers=!0;var a=new customLoadingScreen;engine.loadingScreen=a;engine.displayLoadingUI();activeScene=new SceneMain(engine);VisibilityHandler(activeScene);onResize=function(b){engine.setHardwareScalingLevel(1);engine.resize();var e=engine.getRenderWidth(),f=engine.getRenderHeight();GLOBAL_SCALE_LEVEL=f/Resolution.HEIGHT;Resolution.CORRECTION_MUL=1;f>e&&(GLOBAL_SCALE_LEVEL=e/Resolution.WIDTH);engine.setHardwareScalingLevel(GLOBAL_SCALE_LEVEL);engine.resize();engineRenderWidth=
engine.getRenderWidth();engineRenderHeight=engine.getRenderHeight();2500<engineRenderWidth&&(engine.setHardwareScalingLevel(1),engine.resize(),GLOBAL_SCALE_LEVEL=e/2500,engine.setHardwareScalingLevel(GLOBAL_SCALE_LEVEL),engine.resize(),engineRenderWidth=engine.getRenderWidth(),engineRenderHeight=engine.getRenderHeight());activeScene.onResize(b)};onResize();activeScene.scene.blockMaterialDirtyMechanism=!0;assetLoader=new AssetLoader(activeScene.scene);assetLoader.loadFonts(function(){onResize()});
loadLanguages=function(){languages=new Languages(assetLoader.loadedXMLs["m.isr"]);languages.language="en";var b=navigator.userLanguage||navigator.language;0==b.indexOf("fr")&&(Languages.instance.language="fr");0==b.indexOf("it")&&(Languages.instance.language="it");0==b.indexOf("de")&&(Languages.instance.language="de");0==b.indexOf("es")&&(Languages.instance.language="es");0==b.indexOf("pt")&&(Languages.instance.language="pt");0==b.indexOf("br")&&(Languages.instance.language="pt");0==b.indexOf("ru")&&
(Languages.instance.language="ru");b=getUrlParameterByName("lang");null!==b&&("en"==b&&(Languages.instance.language="en"),"de"==b&&(Languages.instance.language="de"),"es"==b&&(Languages.instance.language="es"),"fr"==b&&(Languages.instance.language="fr"),"it"==b&&(Languages.instance.language="it"),"br"==b&&(Languages.instance.language="pt"),"pt"==b&&(Languages.instance.language="pt"),"ru"==b&&(Languages.instance.language="ru"))};assetLoader.loadSplashAssets(function(){adinplay_init();loadLanguages();
activeScene.scene.blockMaterialDirtyMechanism=!1;activeScene.audioType="mp3";GameData.Load();screenSplash=new ScreenSplash(activeScene.scene);activeScene.addScreen(screenSplash);activeScene.scene.activeCameras=[screenSplash.camera];activeScene.scene.activeCamera=screenSplash.camera;activeScene.scene.cameraToUseForPointers=screenSplash.camera;setGameResolutionByQuality();onResize();onResize();engine.runRenderLoop(function(){activeScene.beforeRender();activeScene.render();activeScene.afterRender()});
window.addEventListener("resize",onResize);window.addEventListener("contextmenu",function(b){b.preventDefault()});document.documentElement.style.overflow="hidden";document.body.scroll="no"})};
...
function onStartGame(){console.warn("start game")}function onGameOver(a,b){var e=ActiveLevel+1;b?GameSnacks.game.gameOver():a?(GameSnacks.game.levelComplete(e),GameSnacks.score.update(e)):GameSnacks.game.gameOver()}
function createGamesnacksButton(){const a=document.createElement("button");a.id="audioButton";a.textContent="AUDIO: "+("true"===localStorage.getItem("soundState"));const b=document.createElement("style");b.textContent="\n        #audioButton {\n            position: fixed;\n            top: 10px;\n            right: 100px;\n            padding: 10px 20px;\n            background-color: #007bff;\n            color: white;\n            border: none;\n            border-radius: 5px;\n            cursor: pointer;\n            z-index: 1000;\n        }\n    ";document.head.appendChild(b);
document.body.appendChild(a);a.addEventListener("click",()=>{soundState=!soundState;localStorage.setItem("soundState",soundState);gamesnacksSoundToggle(soundState);a.textContent="AUDIO: "+soundState})}
if("undefined"==typeof GameSnacks||null==GameSnacks)soundState="true"===localStorage.getItem("soundState"),createGamesnacksButton(),console.warn("GameSnacks is undefined"),GameSnacks={audio:{subscribe:function(){},isEnabled:function(){return soundState}},game:{onPause:function(){},onResume:function(){},firstFrameReady:function(){},ready:function(){},gameOver:function(){},levelComplete:function(a){}},score:{update:function(a){}},ad:{break:function(a,b,e,f,h,m,k){}},storage:{setItem:function(a,b){localStorage.setItem(a,
b)},getItem:function(a){return localStorage.getItem(a)}}};GameSnacks.audio.subscribe(function(a){gamesnacksSoundToggle(a)});let pauseFunction=function(){BABYLON.Engine.audioEngine.setGlobalVolume(0)},unpauseFunction=function(){BABYLON.Engine.audioEngine.setGlobalVolume(1)};GameSnacks.game.onPause(()=>{pauseFunction()});GameSnacks.game.onResume(()=>{unpauseFunction()});
function gamesnacksSoundToggle(a){a&&10>SavedSoundVolume&&(SavedSoundVolume=50);a&&10>SavedMusicVolume&&(SavedMusicVolume=50);null!=soundManager&&(screenSettings.sldrMusicVolume.value=a?SavedMusicVolume:0,screenSettings.sldrSoundsVolume.value=a?SavedSoundVolume:0)}
function showGoogleAd(a,b,e,f,h,m,k){switch(a){case AD_TYPES.PREROLL:a="preroll";break;case AD_TYPES.GAME_LOADED:a="loaded";break;case AD_TYPES.GAME_START:a="start";break;case AD_TYPES.GAME_OVER:a="next";break;default:a="browse"}GameSnacks.ad.break({type:a||"next"})}var showAdFn=null,onGsAdReady=createListener();
function loadRewardedAd(){isAdReady()||GameSnacks.ad.break({type:"reward",beforeReward:a=>{showAdFn=a;onGsAdReady.emit()},beforeAd:()=>{BABYLON.Engine.audioEngine.setGlobalVolume(0)},adDismissed:()=>{},adViewed:()=>{},afterAd:()=>{BABYLON.Engine.audioEngine.setGlobalVolume(1)},adBreakDone:a=>{"ignored"!==a.breakStatus&&(isAdReady()&&("viewed"===a.breakStatus?RewardAds.onSuccess.call(RewardAds.context):RewardAds.onFail.call(RewardAds.context),showAdFn=null,onGsAdReady.emit()),setTimeout(loadRewardedAd,
1E3))}})}function isAdReady(){return null!==showAdFn}function showRewardedAd(a,b,e){isAdReady()?showAdFn():(b.call(e),loadRewardedAd())}inlHelper.ads.onShowAdListeners.push(a=>{showGoogleAd(a.type)});inlHelper.rewardAds.onShowRewardAdListeners.push(showRewardedAd);function createListener(){const a=new Set;return{subscribe(b){a.add(b);return()=>a.delete(b)},emit(b){for(const e of a)e(b)},clear(){a.clear()}}};var POPUP_TRANSITION_DURATION=400,SCENE_TRANSITION_DURATION=250;RewardAds={onSuccess:null,onFail:null,context:null,showRewAd:function(a,b,e,f){this.onSuccess=b;this.onFail=e;this.context=f;inlHelper.rewardAds.showRewardedAd(this.onSuccess,this.onFail,this.context)}};var Languages=function(a){if(null!=Languages.instance)return Languages.instance;Languages.instance=this;Languages.instance.language="en";this.gameTextsParsed=null;this.xml=a;this.gameTextsLists=[];a=this.xml.getElementsByTagName("string");for(var b=0;b<a.length;b++){null==this.gameTextsLists[a.item(b).getAttribute("id")]&&(this.gameTextsLists[a.item(b).getAttribute("id")]=[]);for(var e=0;e<LANGUAGES.length;e++)0<a.item(b).getElementsByTagName(LANGUAGES[e]).length&&(this.gameTextsLists[a.item(b).getAttribute("id")][LANGUAGES[e]]=
...
function setGameResolutionByQuality(){runningOnMobile?(0==GameQuality&&(Resolution.HEIGHT=Resolution.WIDTH=520),1==GameQuality&&(Resolution.HEIGHT=Resolution.WIDTH=420)):(0==GameQuality&&(Resolution.HEIGHT=Resolution.WIDTH=950),1==GameQuality&&(Resolution.HEIGHT=Resolution.WIDTH=650))};var partnerName="google";window.partnerName=partnerName;var GameData=function(){};GameData.BuildTitle="Bus Parking Out";GameData.BuildTitleRU="\u0410\u0432\u0442\u043e\u0431\u0443\u0441\u043d\u0430\u044f \u0421\u0442\u043e\u044f\u043d\u043a\u0430";GameData.BuildVersion="1.0.0";GameData.BuildString="09.01.2025 17:56";GameData.BuildDebug=!1;GameData.Copyright="Inlogic Games 2025";GameData.ProfileName="inl-busout-3d";
...
GameData.Load=function(){GameData.Reset();var a=getUrlParameterByName("reset");null!=a&&"true"===a.toLowerCase()&&GameData.Save();a=null;try{a=JSON.parse(GameSnacks.storage.getItem(GameData.ProfileName))}catch(b){}try{a.DataVersion!=DataVersion?GameData.Save():(SelectedLanguage=a.SelectedLanguage,PlayerCash=a.PlayerCash,ActiveLevel=a.ActiveLevel,SavedGame=a.SavedGame,SavedSoundVolume=a.SavedSoundVolume,SavedMusicVolume=a.SavedMusicVolume,GameQuality=a.GameQuality,OnboardingStep=a.OnboardingStep)}catch(b){GameData.Reset()}null!=
SelectedLanguage&&(Languages.instance.language=SelectedLanguage,activeScene.updateTexts());0==GameSnacks.audio.isEnabled()?SavedMusicVolume=SavedSoundVolume=0:(10>SavedMusicVolume&&(SavedMusicVolume=50),10>SavedSoundVolume&&(SavedSoundVolume=50));OverrideLangFromURL();UpdateDocumentTitle();OnboardingStep=1E3};
GameData.Save=function(){var a={};a.DataVersion=DataVersion;a.SelectedLanguage=SelectedLanguage;a.PlayerCash=PlayerCash;a.ActiveLevel=ActiveLevel;a.SavedGame=SavedGame;a.SavedSoundVolume=SavedSoundVolume;a.SavedMusicVolume=SavedMusicVolume;a.GameQuality=GameQuality;a.OnboardingStep=OnboardingStep;try{GameSnacks.storage.setItem(GameData.ProfileName,JSON.stringify(a))}catch(b){}};function getLevelStars(a){return LevelStars.length<a+1||null==LevelStars[a]?-1:LevelStars[a]}
function setLevelStars(a,b){getLevelStars(a)>b||(LevelStars[a]=b,GameData.Save())}function GetActiveSpecialEvent(){if(null!=TimeToSpecialEvent)return null;var a=SpecialEventTime-GlobalDate.getTime();if(0<Math.floor(a/1E3))return SpecialEventColor}
...
Events.blue.push({goal:12,prize:25});Events.blue.push({goal:12,prize:"rocket"});Events.blue.push({goal:12,prize:25});Events.blue.push({goal:12,prize:"whirlwind"});Events.blue.push({goal:24,prize:"double_event_currency"});Events.blue.push({goal:15,prize:25});Events.blue.push({goal:15,prize:"rocket"});Events.blue.push({goal:15,prize:25});Events.blue.push({goal:15,prize:"whirlwind"});Events.blue.push({goal:30,prize:"double_soft_currency"});var REWARD_LEVEL1_COMPLETED=500,REWARD_LEVEL2_COMPLETED=250,REWARD_LEVEL_COMPLETED=50,REWARD_SMALL_CAR=1,REWARD_MEDIUM_CAR=2,REWARD_BIG_CAR=3,PRICE_BOOSTER_SORT=100,PRICE_BOOSTER_SHUFFLE=100,PRICE_BOOSTER_TURBO=140,PRICE_BOOSTER_SORT_AD=500,PRICE_BOOSTER_SHUFFLE_AD=500,PRICE_BOOSTER_TURBO_AD=700,PRICE_NEW_SPOT=140,BoosterPrices=[];onGsAdReady.subscribe(updateBoosterPrices);updateBoosterPrices();function getLevelReward(a){return 0==ActiveLevel?300:1==ActiveLevel?150:50}
function updateBoosterPrices(){inlHelper.rewardAds.active&&isAdReady()?(BoosterPrices.sort=PRICE_BOOSTER_SORT_AD,BoosterPrices.shuffle=PRICE_BOOSTER_SHUFFLE_AD,BoosterPrices.turbo=PRICE_BOOSTER_TURBO_AD):(BoosterPrices.sort=PRICE_BOOSTER_SORT,BoosterPrices.shuffle=PRICE_BOOSTER_SHUFFLE,BoosterPrices.turbo=PRICE_BOOSTER_TURBO)};var Levels=[{gridSize:4,levelSeed:0,onboarding:!0,buses:[{id:0,position:[1,1],size:3,direction:"left",color:"blue"},{id:1,position:[0,2],size:2,direction:"up",color:"red"},{id:2,position:[4,1],size:3,direction:"up",color:"purple"},{id:3,position:[1,3],size:2,direction:"left",color:"orange"}]},{gridSize:6,levelSeed:7327849,colors:["blue","red","yellow"]},{gridSize:8,levelSeed:1567504,colors:["purple","pink","teal","yellow"]},{gridSize:10,levelSeed:13808656,colors:["red","pink","teal","yellow","green"]},
...
SetImageFromSpritesheet(k.imgSlider,getAssetImage("pak1"),getAssetImageFrames("pak1"),m);k.onPointerDownObservable.add(function(n,v){0!=GameSnacks.audio.isEnabled()&&(this._sliding=!0,v=v.currentTarget.transformedMeasure,this.value=this._minimum+(n.x-(v.left+this._sliderGap))/(v.width-2*this._sliderGap)*(this._maximum-this._minimum))}.bind(k));k.onPointerMoveObservable.add(function(n,v){this._sliding&&(v=v.currentTarget.transformedMeasure,this.value=this._minimum+(n.x-(v.left+this._sliderGap))/(v.width-
2*this._sliderGap)*(this._maximum-this._minimum))}.bind(k));k.onPointerOutObservable.add(function(n,v){this._sliding&&(this._sliding=!1)}.bind(k));k.onPointerUpObservable.add(function(n,v){this._sliding&&(this._sliding=!1)}.bind(k));k.widthInPixels=k.imgSliderBg.widthInPixels+2*k._sliderGap;k.heightInPixels=k.imgSliderBg.heightInPixels+2*k._sliderGap;Object.defineProperty(k,"value",{get:function(){return this._value},set:function(n){n<this._minimum&&(n=this._minimum);n>this._maximum&&(n=this._maximum);
this._value=n;var v=(this._value-this._minimum)/(this._maximum-this._minimum);this.imgSliderFill.sourceWidth=this.imgSliderFill.fullWidth*v;this.imgSliderFill.widthInPixels=this.imgSliderFill.fullWidth*v;this.imgSlider.leftInPixels=this.imgSliderFill.leftInPixels+this.imgSliderFill.widthInPixels-.5*this._sliderGap+this._sliderGap*v-this.imgSlider.widthInPixels*v;this.onValueChanged(n)},enumerable:!0,configurable:!0});Object.defineProperty(k,"sliderGap",{get:function(){return this._sliderGap},set:function(n){this._sliderGap=
n;this.widthInPixels=this.imgSliderBg.widthInPixels;this.heightInPixels=this.imgSliderBg.heightInPixels;this.imgSliderFill.leftInPixels=(this.imgSliderBg.sourceWidth-this.imgSliderFill.sourceWidth)/2},enumerable:!0,configurable:!0});return k};var FRAME_RATE=60,CommonAnimations={AnimateObjectProperty:function(a,b,e,f,h,m,k,n,v){void 0===h&&(h=null);void 0===m&&(m=1);void 0===k&&(k=!1);void 0===n&&(n=null);var w=new BABYLON.Animation("animateObjectProperty",b,FRAME_RATE,BABYLON.Animation.ANIMATIONTYPE_FLOAT,BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);w.setKeys([{frame:0,value:fetchFromObject(a,b)},{frame:Math.floor(FRAME_RATE*f/1E3),value:e}]);if(null!=v){b=[];for(e=0;e<v.length;e++)b.push({frame:Math.floor(FRAME_RATE*f/1E3)*v[e][0],value:v[e][1]});
...
"layerMask",b);return a}};function getAssetImage(a){var b=a+".png";AssetLoader.instance.loadedImages.hasOwnProperty(b)||console.error("getAssetImage( "+a+") : image not found");return AssetLoader.instance.loadedImages[b]}function getAssetImageFrames(a){var b=a+".json";AssetLoader.instance.loadedJSONs.hasOwnProperty(b)||console.error("getAssetImageFrames( "+a+") : json not found");return AssetLoader.instance.loadedJSONs[b].frames};SoundManager=function(a){SoundManager.instance=this;this.scene=a;try{this.musicVolume=this.soundVolume=1,GameSnacks.storage.getItem(GameData.ProfileName+"-sounds")&&(this.soundVolume=GameSnacks.storage.getItem(GameData.ProfileName+"-sounds")),GameSnacks.storage.getItem(GameData.ProfileName+"-music")&&(this.musicVolume=GameSnacks.storage.getItem(GameData.ProfileName+"-music"))}catch(b){this.musicVolume=this.soundVolume=1}0==GameSnacks.audio.isEnabled()?this.musicVolume=this.soundVolume=0:(.1>this.soundVolume&&
(this.soundVolume=.5),.1>this.musicVolume&&(this.musicVolume=.5));this.music=[];this.sounds=[];this.prevSoundPlayed=this.actualMusic=null;this.create()};SoundManager.instance=null;
...
setMusicVolume:function(a){this.musicVolume=a;GameSnacks.storage.setItem(GameData.ProfileName+"-music",this.musicVolume);for(var b in this.music)"contains"!=b&&"remove"!=b&&this.music[b].setVolume(this.music[b].VOLUME*this.musicVolume)},setSoundsVolume:function(a){this.soundVolume=a;GameSnacks.storage.setItem(GameData.ProfileName+"-sounds",this.soundVolume);for(var b in this.sounds)"contains"!=b&&"remove"!=b&&this.sounds[b].setVolume(this.sounds[b].VOLUME*this.soundVolume)}};var explosionSounds="single_hit_1 single_hit_2 single_hit_3 single_hit_4 single_hit_5 single_hit_6 single_hit_7 single_hit_8 single_hit_9 single_hit_10".split(" ");
...
BABYLON.GUI.AdvancedDynamicTexture.CreateFullscreenUI("ScreenSplash_GUI",!0,activeScene.scene);this.guiTexture.layer.layerMask=LAYER_SCREEN_BACKGROUND;this.guiTexture.rootContainer.highlightLineWidth=0;this.initGuiControls(this.guiTexture);GameSnacks.game.firstFrameReady()},initGuiControls:function(a){this.pnlBackground=new BABYLON.GUI.Rectangle;this.pnlBackground.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.pnlBackground.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;
this.pnlBackground.widthInPixels=300;this.pnlBackground.heightInPixels=300;this.pnlBackground.background="#BB464B";this.pnlBackground.thickness=0;a.addControl(this.pnlBackground);this.imgSplash=new BABYLON.GUI.Image;this.imgSplash.transformCenterX=.5;this.imgSplash.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgSplash.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgSplash.isPointerBlocker=!1;this.imgSplash.isHitTestVisible=!1;this.imgSplash.topInPixels=
0;this.imgSplash.domImage=AssetLoader.instance.loadedImages["splash.jpg"];a.addControl(this.imgSplash);this.imgLogo=new BABYLON.GUI.Image;this.imgLogo.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_LEFT;this.imgLogo.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_TOP;this.imgLogo.isPointerBlocker=!1;this.imgLogo.isHitTestVisible=!1;this.imgLogo.topInPixels=0;this.imgLogo.domImage=AssetLoader.instance.loadedImages["gametitle_en.png"];"ru"==Languages.instance.language&&(this.imgLogo.domImage=
AssetLoader.instance.loadedImages["gametitle_ru.png"]);a.addControl(this.imgLogo);this.txtContinue=this.createContinueText();this.txtContinue.alpha=14;a.addControl(this.txtContinue);this.imgInlogicSplash=new BABYLON.GUI.Image;this.imgInlogicSplash.transformCenterX=.5;this.imgInlogicSplash.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgInlogicSplash.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgInlogicSplash.isPointerBlocker=!1;this.imgInlogicSplash.isHitTestVisible=
!1;this.imgInlogicSplash.topInPixels=0;this.imgInlogicSplash.domImage=AssetLoader.instance.loadedImages["main_bg.jpg"];a.addControl(this.imgInlogicSplash);this.imgInlogicLogo=new BABYLON.GUI.Image;this.imgInlogicLogo.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_LEFT;this.imgInlogicLogo.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_TOP;this.imgInlogicLogo.isPointerBlocker=!1;this.imgInlogicLogo.isHitTestVisible=!1;this.imgInlogicLogo.topInPixels=0;this.imgInlogicLogo.alpha=
0;this.imgInlogicLogo.domImage=AssetLoader.instance.loadedImages["gametitle_en.png"];a.addControl(this.imgInlogicLogo);var b=800;setTimeout(function(){CommonAnimations.AnimateObjectProperty(this.imgInlogicLogo,"alpha",1,b,null,1,!1,function(){setTimeout(function(){loadGameAssets();b=400;CommonAnimations.AnimateObjectProperty(this.imgInlogicSplash,"alpha",0,b,null,1,!1);CommonAnimations.AnimateObjectProperty(this.imgInlogicLogo,"alpha",0,b,null,1,!1,function(){this.imgInlogicSplash.isVisible=!1;this.imgInlogicLogo.isVisible=
!1}.bind(this))}.bind(this),1E3)}.bind(this))}.bind(this),150);this.guiRoot=this.imgSplash.parent},allAssetsLoaded:function(){this.txtContinue.text=STR("TAP_TO_CONTINUE");CommonAnimations.AnimateObjectProperty(this.txtContinue,"alpha",.8,800,null,1,!0,null,[[0,1],[.5,.9],[1,1]]);GameSnacks.game.ready();this.pnlBackground.onPointerClickObservable.add(function(){Buttons.enabled&&(inlHelper.ads.triggerAdPoint({adType:AD_TYPES.GAME_LOADED}),Buttons.enabled=!1,BABYLON.Engine.audioEngine.unlocked||BABYLON.Engine.audioEngine.unlock(),
...
ScreenGame.prototype={create:function(a){this.scene=a;this.rootNode=new BABYLON.TransformNode("ScreenGame");this.createCamera();this.createMaterials();this.createGui();this.initLevel();this.disableControls();this.keyboardSpacePressed=this.guiRoot.isVisible=!1;this.collectedGifts=0;this.rootNode.setEnabled(!1);onGsAdReady.subscribe(()=>this.switchVersion(inlHelper.rewardAds.active&&isAdReady()));this.switchVersion(inlHelper.rewardAds.active&&isAdReady())},createGui:function(){this.guiTexture=BABYLON.GUI.AdvancedDynamicTexture.CreateFullscreenUI("ScreenGame");
this.guiTexture.layer.layerMask=this.cameraPlayer.layerMask;this.guiTexture.rootContainer.highlightLineWidth=0;this.guiTexture.onControlPickedObservable.add(function(a){});this.initGuiControls(this.guiTexture)},createDemoTxts:function(){this.txtDemoHore=new BABYLON.GUI.TextBlock("txtDemoHore");this.txtDemoHore.textWrapping=!1;this.txtDemoHore.topInPixels=.51*-Resolution.HEIGHT;this.txtDemoHore.widthInPixels=2*Resolution.WIDTH;this.txtDemoHore.verticalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;
this.txtDemoHore.horizontalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.txtDemoHore.color="#FFFFFF";this.txtDemoHore.text="DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO DEMO";this.txtDemoHore.fontSize="25px";this.txtDemoHore.fontFamily="gamefont";this.txtDemoHore.isPointerBlocker=!1;this.txtDemoHore.isFocusInvisible=!0;this.pnlRoot.guiTexture.addControl(this.txtDemoHore)},initGuiControls:function(a){this.createRootPanel(a);
this.pnlRoot.topInPixels=-50;this.createBoostersPanel(this.pnlRoot);this.createOverlay(this.pnlRoot);this.boosterRockets=[]},createAnimatedPlanes:function(){this.animatedPlanes=[];for(var a=0;5>a;a++)this.animatedPlanes[a]=this.createAnimatedPlane(this.explosionMaterial,"expl","expl_1.png expl_2.png expl_3.png expl_4.png expl_5.png expl_6.png expl_7.png expl_8.png expl_9.png expl_10.png expl_11.png expl_12.png expl_13.png expl_14.png".split(" "))},updateAnimatedPlanes:function(a){for(var b=0;b<this.animatedPlanes.length;b++)this.animatedPlanes[b].animationStep(a)},
createAnimatedPlane:function(a,b,e){var f=BABYLON.Mesh.CreatePlane("plane",6,this.scene);f.setParent(this.rootNode);f.position.y=4;f.layerMask=LAYER_SCREEN_GAME;f.material=a;f.billboardMode=7;f.isVisible=!1;f.animPak=b;f.animFrames=e;f.animDelay=25;f.frameDelay=f.animDelay;f.activeFrame=0;f.animLoop=!1;f.animPaused=!1;f.animationStep=function(h){if(this.isVisible&&!this.animPaused&&(this.frameDelay-=h,!(0<=this.frameDelay))){this.frameDelay=this.animDelay;this.activeFrame++;if(this.activeFrame>=this.animFrames.length-
1){if(!this.animLoop){this.isVisible=!1;return}this.activeFrame=0}this.updateFrame()}};f.updateFrame=function(){this.isVisible&&SetTextureFromSpritesheet(this.material.diffuseTexture,getAssetImageFrames(this.animPak),this.animFrames[this.activeFrame])};f.reset=function(){this.activeFrame=0;this.animPaused=!1;this.isVisible=!0;this.updateFrame()};f.updateFrame();return f},playAnimatedPlane:function(a){for(var b=0;b<this.animatedPlanes.length;b++)this.animatedPlanes[b].isVisible||(this.animatedPlanes[b].reset(),
this.animatedPlanes[b].position=v3(a.x,a.y,a.z))},createRootPanel:function(a){this.pnlRoot=new BABYLON.GUI.Rectangle("ScreenGame.pnlRoot");this.pnlRoot.transformCenterX=.5;this.pnlRoot.transformCenterY=.5;this.pnlRoot.isPointerBlocker=!1;this.pnlRoot.isHitTestVisible=!1;this.pnlRoot.leftInPixels=0;this.pnlRoot.topInPixels=0;this.pnlRoot.thickness=0;this.pnlRoot.highlightLineWidth=0;this.pnlRoot.clipChildren=!1;this.pnlRoot.clipContent=!1;this.pnlRoot.zIndex=0;a.addControl(this.pnlRoot);this.guiRoot=
this.pnlRoot},createBoostersPanel:function(a){this.imgBottomMask=new BABYLON.GUI.Image("imgBottomMask");this.imgBottomMask.transformCenterX=.5;this.imgBottomMask.transformCenterY=.5;this.imgBottomMask.isPointerBlocker=!1;this.imgBottomMask.isHitTestVisible=!1;this.imgBottomMask.leftInPixels=0;this.imgBottomMask.topInPixels=0;this.imgBottomMask.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgBottomMask.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_BOTTOM;SetImageFromSpritesheet(this.imgBottomMask,
getAssetImage("pak1"),getAssetImageFrames("pak1"),"void.png");a.addControl(this.imgBottomMask);this.imgBottomMask.onResize=function(b,e){this.widthInPixels=b;this.heightInPixels=.2*e};this.pnlBoosters=new BABYLON.GUI.Rectangle("pnlBooster");this.pnlBoosters.transformCenterX=.5;this.pnlBoosters.transformCenterY=0;this.pnlBoosters.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.pnlBoosters.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_TOP;this.pnlBoosters.isPointerBlocker=
!1;this.pnlBoosters.isHitTestVisible=!1;this.pnlBoosters.leftInPixels=0;this.pnlBoosters.topInPixels=0;this.pnlBoosters.thickness=0;this.pnlBoosters.color="green";this.pnlBoosters.widthInPixels=750;this.pnlBoosters.heightInPixels=170;this.pnlBoosters.highlightLineWidth=0;this.pnlBoosters.clipChildren=!1;this.pnlBoosters.clipContent=!0;this.pnlBoosters.isVisible=!0;a.addControl(this.pnlBoosters);this.pnlBoosters.scaleTo=function(b){this.scaleX=this.scaleY=b};this.pnlBoosters.setPosition=function(b,
e){this.leftInPixels=b*Resolution.SCALE/this.scaleX;this.topInPixels=e*Resolution.SCALE/this.scaleY};this.pnlBoosters.pnlSlots=[];this.pnlBoosters.itemWidth=1.5*this.pnlBoosters.heightInPixels;this.pnlBoosters.reset=function(){for(;0<this.pnlBoosters.pnlSlots.length;)this.pnlBoosters.pnlSlots[0].dispose(),this.pnlBoosters.pnlSlots.splice(0,1)};this.pnlBoosters.getBoosterByName=function(b){for(var e=0;e<this.pnlSlots.length;e++)if(this.pnlSlots[e].booster==b)return this.pnlSlots[e];return null};this.pnlBoosters.addBooster=
function(b){var e=new BABYLON.GUI.Rectangle("pnlBooster");e.transformCenterX=.5;e.transformCenterY=.5;e.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;e.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_TOP;e.isPointerBlocker=!1;e.isHitTestVisible=!1;e.leftInPixels=0;e.topInPixels=0;e.thickness=0;e.color="yellow";e.widthInPixels=this.itemWidth;e.heightInPixels=this.itemWidth;e.highlightLineWidth=0;e.clipChildren=!1;e.clipContent=!1;e.isVisible=!0;e.booster=b;this.addControl(e);
var f=new BABYLON.GUI.Image("imgBoosterBg");f.transformCenterX=.5;f.transformCenterY=.5;f.isPointerBlocker=!1;f.isHitTestVisible=!1;f.leftInPixels=0;f.topInPixels=0;f.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;f.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;SetImageFromSpritesheet(f,getAssetImage("pak1"),getAssetImageFrames("pak1"),"button_top_blue.png");e.addControl(f);f=BABYLON.GUI.Button.CreateImageOnlyButton("imgBoosterBtn");f.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;
...
inlHelper.rewardAds.active?SetTextureFromSpritesheet(f.material.diffuseTexture,getAssetImageFrames("digits"),"icon_watch_ad.png"):SetTextureFromSpritesheet(f.material.diffuseTexture,getAssetImageFrames("digits"),"stand_coin.png");this.parkingSpots[a].icon=f;e=220;f=BABYLON.MeshBuilder.CreatePlane("price3d",{frontUVs:new BABYLON.Vector4(0,0,1,1)});f.parent=this.parkingSpots[a].model.rootNodes[0];f.scaling=v3(2*e,1*e,1*e);f.rotation=v3(DegToRad(90),DegToRad(90),0);f.position=v3(0,1,0);f.layerMask=LAYER_SCREEN_GAME;
f.isPickable=!0;f.parkingSpot=this.parkingSpots[a];f.material=new BABYLON.StandardMaterial("price3d_material_"+a,activeScene.scene);f.material.diffuseTexture=new BABYLON.DynamicTexture("price3d_texture_"+a,{width:128,height:64},activeScene.scene);e=f.material.diffuseTexture.getContext();this.drawStrokedText(e,"60px gameFont",15,52,""+PRICE_NEW_SPOT);f.material.diffuseTexture.update();this.parkingSpots[a].price=f}},switchVersion:function(a){for(var b=0;b<this.parkingSpots.length;b++){var e=this.parkingSpots[b].icon;
null!=e&&(SetTextureFromSpritesheet(e.material.diffuseTexture,getAssetImageFrames("digits"),a?"icon_watch_ad.png":"stand_coin.png"),this.parkingSpots[b].price.isVisible=e.isVisible&&!a)}},updateOuterRightPOIPosition:function(a){var b=this.getObjectProjection2D(this.levelPOITopRightOuter.position);if(b.x<a)for(;b.x<a;)--this.levelPOITopRightOuter.position.x,--this.levelPOITopRightOuter.position.z,b=this.getObjectProjection2D(this.levelPOITopRightOuter.position);else if(b.x>a){for(;b.x>a;)this.levelPOITopRightOuter.position.x+=
1,this.levelPOITopRightOuter.position.z+=1,b=this.getObjectProjection2D(this.levelPOITopRightOuter.position);--this.levelPOITopRightOuter.position.x;--this.levelPOITopRightOuter.position.z}},drawStrokedText:function(a,b,e,f,h){a.fillStyle="rgb(96, 108, 143)";a.fillRect(0,0,128,64);a.font=b;a.strokeStyle="black";a.lineWidth=10;a.strokeText(h,e,f);a.fillStyle="white";a.fillText(h,e,f)},setQueuePanelNumber:function(a){a=leadingZero(a,3);SetTextureFromSpritesheet(this.queuePanelModel.digit1.material.albedoTexture,
getAssetImageFrames("digits"),"num_"+a[0]+".png");this.queuePanelModel.digit1.material.markAsDirty();this.queuePanelModel.digit1.material.markDirty(!0);SetTextureFromSpritesheet(this.queuePanelModel.digit2.material.albedoTexture,getAssetImageFrames("digits"),"num_"+a[1]+".png");this.queuePanelModel.digit2.material.markAsDirty();this.queuePanelModel.digit2.material.markDirty(!0);SetTextureFromSpritesheet(this.queuePanelModel.digit3.material.albedoTexture,getAssetImageFrames("digits"),"num_"+a[2]+".png");
this.queuePanelModel.digit3.material.markAsDirty();this.queuePanelModel.digit3.material.markDirty(!0)},setLevelBorderSize:function(a){var b=a/2;this.levelBorderRight.position.x=-b;this.levelBorderRight.position.z=-b;this.levelBorderLeft.position.x=b;this.levelBorderLeft.position.z=b;this.levelBorderTop.position.x=b;this.levelBorderTop.position.z=-b;this.levelBorderBottom.position.x=-b;this.levelBorderBottom.position.z=b;this.levelPOITopLeft.position.x=a-1.5;this.levelPOITopLeft.position.z=0;this.levelPOIBottomRight.position.x=
-(a-1.5);this.levelPOIBottomRight.position.z=0;this.levelPOITopRight.position.x=0;this.levelPOITopRight.position.z=-(a-1.5);this.levelPOIBottomLeft.position.x=0;this.levelPOIBottomLeft.position.z=a-1.5;this.levelPOITopRightOuter.position.x=this.levelPOITopRight.position.x-5;this.levelPOITopRightOuter.position.z=this.levelPOITopRight.position.z-5-.2;this.levelQueueSpawn.position.x=this.levelPOITopRight.position.x+3.7;this.levelQueueSpawn.position.z=this.levelPOITopRight.position.z-3.7+.2;this.queueEntranceModel.position.x=
this.levelQueueSpawn.position.x-.2+.5;this.queueEntranceModel.position.z=this.levelQueueSpawn.position.z-.3-.5;this.levelQueueStop.position.x=this.levelPOITopLeft.position.x-3.7+3.2-.2;this.levelQueueStop.position.z=this.levelPOITopLeft.position.z-11.1+2-.2+.7;a=this.levelPOITopLeft.position.x-2.6;b=this.levelPOITopLeft.position.z-2.6;for(var e=0;e<this.preParkingSpots.length;e++)this.prePreParkingSpots[e].position.x=a+3.2,this.prePreParkingSpots[e].position.z=b-2.5,this.preParkingSpots[e].spotFree=
!0,this.preParkingSpots[e].position.x=a,this.preParkingSpots[e].position.z=b,this.parkingSpots[e].spotFree=!0,this.parkingSpots[e].position.x=a+2,this.parkingSpots[e].position.z=b-1,this.parkingSpots[e].lookAt(this.preParkingSpots[e].position),this.preParkingSpots[e].lookAt(this.parkingSpots[e].position),a-=1.5,b-=1.5;this.queuePanelModel.position.x=this.prePreParkingSpots[1].position.x+1;this.queuePanelModel.position.z=this.prePreParkingSpots[1].position.z},resetParkingSpots:function(){for(var a=
0;a<this.preParkingSpots.length;a++)this.prePreParkingSpots[a].spotFree=!0,this.preParkingSpots[a].spotFree=!0,this.parkingSpots[a].spotFree=!0,this.parkingSpots[a].parkedBus=null,null!=this.parkingSpots[a].icon&&(this.parkingSpots[a].icon.isVisible=!0,null!=this.parkingSpots[a].price&&(this.parkingSpots[a].price.isVisible=!inlHelper.rewardAds.active||!isAdReady()))},createHighlightLayer:function(){null!=this.highlightLayer&&this.highlightLayer.dispose();this.highlightLayer=new BABYLON.HighlightLayer("highlightLayer",
activeScene.scene,{isStroke:!0,mainTextureRatio:.8/Resolution.SCALE});this.highlightLayer.anim1=CommonAnimations.AnimateObjectProperty(this.highlightLayer,"blurVerticalSize",1.5,1E3,null,1,!0,null,[[0,1],[.5,0],[1,1]]);this.highlightLayer.anim2=CommonAnimations.AnimateObjectProperty(this.highlightLayer,"blurHorizontalSize",1.5,1E3,null,1,!0,null,[[0,1],[.5,0],[1,1]])},incScore:function(a,b,e){TextParticles.instance.CreateTextParticle1(b.x-this.activeViewportCenter.x,b.y-this.activeViewportCenter.y,
"+"+a,25,e)},raycast:function(a,b){a=new BABYLON.Ray(a,b,30);(new BABYLON.RayHelper(a)).show(activeScene.scene);return activeScene.scene.pickWithRay(a).pickedMesh},getObjectProjection2D:function(a){a=BABYLON.Vector3.Project(a,BABYLON.Matrix.Identity(),this.cameraPlayer.getTransformationMatrix(),this.cameraPlayer.viewport.toGlobal(engineRenderWidth,engineRenderHeight));a.x*=this.guiTexture.renderScale;a.y*=this.guiTexture.renderScale;return a},TransformCoordinatesWithClipping:function(a,b){const e=
b.m;b=a.x*e[0]+a.y*e[4]+a.z*e[8]+e[12];let f=a.x*e[1]+a.y*e[5]+a.z*e[9]+e[13],h=a.x*e[2]+a.y*e[6]+a.z*e[10]+e[14];a=a.x*e[3]+a.y*e[7]+a.z*e[11]+e[15];b<-a&&(b=-a);b>a&&(b=a);f<-a&&(f=-a);f>a&&(f=a);h<-a&&(h=-a);h>a&&(h=a);0>a&&(a=0);return new BABYLON.Vector3(b/a,f/a,h/a)},resetGame:function(a,b,e,f){this.pnlBoosters.isVisible=!0;this.pnlOverlay.alpha=0;this.pnlOverlay.isVisible=!1;this.resetBuses();this.createHighlightLayer();this.createLevel(a,b,e,f);this.resetPeople();this.resetParkingSpots();
this.onResize();this.gameOverDelay=GAME_OVER_DELAY;this.orthoZoom=1;this.onboardingActive?this.disableBoosterButtons():this.enableBoosterButtons();isAdReady()||loadRewardedAd()},disableBoosterButtons:function(){for(var a=0;a<this.pnlBoosters.pnlSlots.length;a++)disableButton(this.pnlBoosters.pnlSlots[a]),this.pnlBoosters.pnlSlots[a].isVisible=!1},enableBoosterButtons:function(){for(var a=0;a<this.pnlBoosters.pnlSlots.length;a++)enableButton(this.pnlBoosters.pnlSlots[a]),this.pnlBoosters.pnlSlots[a].isVisible=
!0},gameStep_start:function(){activeScene.gameRunning=!0;activeScene.gamePaused=!1;screenGame.enableControls();this.onboardingActive&&(Buttons.enabled=!1,setTimeout(function(){this.selectWithHandBusById(this.onboardingBusId);screenHand.imgHand.alpha=0;screenHand.pnlRoot.isVisible=this.onboardingActive;CommonAnimations.AnimateObjectProperty(screenHand.imgHand,"alpha",1,SCENE_TRANSITION_DURATION,{func:BABYLON.CircleEase,mode:BABYLON.EasingFunction.EASINGMODE_EASEIN},1,!1,function(){Buttons.enabled=
!0})}.bind(this),500))},gameStep_levelCompleted:function(){activeScene.gameRunning=!1;screenGame.disableControls();soundManager.playSound("won");onGameOver(!0);inlHelper.rewardAds.active&&isAdReady()?screenLevelCompletedADs.showScene():screenLevelCompleted.showScene()},gameStep_levelFailed:function(){activeScene.gameRunning=!1;screenGame.disableControls();soundManager.playSound("lost");onGameOver(!1);null==this.getSpotForPurchase()?screenLevelFailed.showScene():screenContinue.showScene()},vecToLocal:function(a,
b){b=b.getWorldMatrix();return BABYLON.Vector3.TransformCoordinates(a,b)},updateData:function(){},enableControls:function(){for(var a=0;a<this.pnlBoosters.pnlSlots.length;a++)enableButton(this.pnlBoosters.pnlSlots[a].imgBoosterBtn)},disableControls:function(){for(var a=0;a<this.pnlBoosters.pnlSlots.length;a++)disableButton(this.pnlBoosters.pnlSlots[a].imgBoosterBtn)},showControls:function(){showControl(this.btnMenu)},hideControls:function(){hideControl(this.btnMenu)},beforeRender:function(){activeScene.gameRunning&&
!activeScene.gamePaused&&(this.updateExplosions(),this.updateBuses(),this.updatePeople())},updateZoom:function(){1>=this.orthoZoom||(this.orthoZoom-=.1*activeScene.getCpuSpeedMul(),this.onResize())},updateBuses:function(){this.updateBusesToMove();this.updateBusesToPark();this.updateBusesToGo();this.updateBusesPeopleOnboardPositions()},updateBusesToMove:function(){for(var a=0;a<this.busesToMove.length;a++)this.updateBusToMove(this.busesToMove[a])},updateBusesToPark:function(){for(var a=0;a<this.busesToPark.length;a++)this.updateBusToPark(this.busesToPark[a])},
updateBusesToGo:function(){0<this.busToGoDelay&&(this.busToGoDelay-=activeScene.deltaTime,0>this.busToGoDelay&&(this.busToGoDelay=0));for(var a=0;a<this.busesToGo.length;a++)this.updateBusToGo(this.busesToGo[a])},updateBusesPeopleOnboardPositions:function(){for(var a=0;a<this.buses.length;a++){var b=this.buses[a];if(0!=b.peopleOnboard.length)for(var e=0;e<b.peopleOnboard.length;e++)if(b.peopleOnboard[e].isVisible){var f=null;b.carTop&&(f=traverseFindChildNodeByName(b._children[0],"car_seat"+this.getTranslatedSeatIdx(e+
1)));b.vanTop&&(f=traverseFindChildNodeByName(b._children[0],"van_seat"+this.getTranslatedSeatIdx(e+1)));b.busTop&&(f=traverseFindChildNodeByName(b._children[0],"bus_seat"+this.getTranslatedSeatIdx(e+1)));null!=f&&(f=f.absolutePosition.clone(),f.y=2.094,1==e%2?(f.x-=.35+.05,f.z-=-.04):(f.x-=.25,f.z+=.3),b.peopleOnboard[e].setAbsolutePosition(f),b.peopleOnboard[e].renderingGroupId=1)}}},getTranslatedSeatIdx:function(a){return 0!=a%2?a+1:a-1},busAlreadyMoving:function(a){for(var b=0;b<this.busesToMove.length;b++)if(this.busesToMove[b]==
a)return!0;for(b=0;b<this.busesToPark.length;b++)if(this.busesToPark[b]==a)return!0;for(b=0;b<this.busesToGo.length;b++)if(this.busesToGo[b]==a)return!0;return!1},removeBusToMove:function(a){for(var b=0;b<this.busesToMove.length;b++)if(this.busesToMove[b]==a){this.busesToMove.splice(b,1);break}},removeBusToPark:function(a){for(var b=0;b<this.busesToPark.length;b++)if(this.busesToPark[b]==a){this.busesToPark.splice(b,1);break}},removeBusToGo:function(a){for(var b=0;b<this.busesToGo.length;b++)if(this.busesToGo[b]==
a){this.busesToGo.splice(b,1);break}},openBusesFreeToMove:function(){for(var a=0;a<this.buses.length;a++)this.closeRoofBus3d(this.buses[a]);var b=this.getBusesToMoveFreely();for(a=0;a<b.length;a++)this.openRoofBus3d(b[a])},generateWaitingQueue:function(){for(var a=[],b=this.buses.length-1;0<=b;b--){var e=this.buses[b];a.push({id:e.uniqueId,bus3d:e,color:e.busData.color,capacity:e.capacity})}for(var f=function(m){for(var k=[],n=[],v=0,w=0;w<m.length;w++){var r=m[w];n.hasOwnProperty(r.color)||(n[r.color]=
0);n[r.color]+=r.capacity;v+=r.capacity}m=Object.keys(n);m.sort(function(Q,R){return n[R]-n[Q]});r=[];0<m.length&&(r.push(m[0]),m.splice(0,1));0<m.length&&(r.push(m[0]),m.splice(0,1));for(;0<m.length||0<r.length;)for(var y=0;5>y;y++){for(w=0;w<r.length;w++){var z=7+getRandomIntWithSeed(3,screenGame.levelSeed+100*(screenGame.preparedQueue.length+k.length));n[r[w]]<z&&(z=n[r[w]]);n[r[w]]-=z;for(var L=0;L<z;L++)k.push(r[w]);0==n[r[w]]&&(r.splice(w,1),w--);v-=z;if(0==v)return k}0<m.length&&(r.push(m[0]),
m.splice(0,1))}return[]};0<a.length;){var h=[];for(b=a.length-1;0<=b;b--)e=a[b],e.free=this.isBusFreeToMove(e.bus3d),e.free&&(h.push(e),a.splice(b,1));for(b=0;b<h.length;b++)h[b].bus3d.testCollisions=!1;e=f(h);for(b=0;b<e.length;b++)this.preparedQueue.push(e[b])}for(b=this.buses.length-1;0<=b;b--)this.buses[b].testCollisions=!0},_generateWaitingQueue:function(){if(!(20<this.preparedQueue.length)){for(var a=this.getBusesToMoveFreely(),b=0;b<a.length;b++){var e=a[b];e.queued||(e.queued=!0,this.seatsOfColor[e.busData.color]+=
e.capacity)}e=Object.keys(this.seatsOfColor);e.sort(function(h,m){return screenGame.seatsOfColor[m]-screenGame.seatsOfColor[h]});for(b=0;b<e.length;b++)0==this.seatsOfColor[e[b]]&&(e.splice(b,1),b--);a=[];0<e.length&&a.push(e[0]);1<e.length&&a.push(e[1]);if(0!=a.length)for(;20>this.preparedQueue.length;)for(b=0;b<a.length;b++){e=8+getRandomIntWithSeed(1,this.levelSeed+100*this.departedBuses);this.seatsOfColor[a[b]]<e&&(e=this.seatsOfColor[a[b]]);if(0==e)return;this.seatsOfColor[a[b]]-=e;for(var f=
0;f<e;f++)this.preparedQueue.push(a[b])}}},getBusesToMoveFreely:function(){for(var a=[],b=0;b<this.buses.length;b++)this.isBusFreeToMove(this.buses[b])&&a.push(this.buses[b]);return a},isBusFreeToMove:function(a){var b=0,e=0,f=a.position.clone();"left"==a.busData.direction&&(e=-90-RadToDeg(a.rotation.y),b=.5*Math.cos(DegToRad(e)),e=.5*Math.sin(DegToRad(e)));"right"==a.busData.direction&&(e=90-RadToDeg(a.rotation.y),b=.5*-Math.cos(DegToRad(e)),e=.5*-Math.sin(DegToRad(e)));"up"==a.busData.direction&&
(e=0-RadToDeg(a.rotation.y),b=.5*Math.sin(DegToRad(e)),e=.5*-Math.cos(DegToRad(e)));"down"==a.busData.direction&&(e=180-RadToDeg(a.rotation.y),b=.5*-Math.sin(DegToRad(e)),e=.5*Math.cos(DegToRad(e)));for(var h=0;5>h;h++)if(a.position.x+=b,a.position.z+=e,a.computeWorldMatrix(!0),this.busInCollisionWithOtherBuses(a))return a.position=f,a.computeWorldMatrix(!0),!1;a.position=f;a.computeWorldMatrix(!0);return!0},updateBusToMove:function(a){var b=activeScene.getCpuSpeedMul()*BUS_SPEED,e=0,f=0;"left"==
a.busData.direction&&(f=-90-RadToDeg(a.rotation.y),e=Math.cos(DegToRad(f))*b,f=Math.sin(DegToRad(f))*b);"right"==a.busData.direction&&(f=90-RadToDeg(a.rotation.y),e=-Math.cos(DegToRad(f))*b,f=-Math.sin(DegToRad(f))*b);"up"==a.busData.direction&&(f=0-RadToDeg(a.rotation.y),e=Math.sin(DegToRad(f))*b,f=-Math.cos(DegToRad(f))*b);"down"==a.busData.direction&&(f=180-RadToDeg(a.rotation.y),e=-Math.sin(DegToRad(f))*b,f=Math.cos(DegToRad(f))*b);if(!a.collided){var h=a.position.clone();h.x-=e/b*a.busData.size*
.6;h.z-=f/b*a.busData.size*.6;a.position.x+=e;a.position.z+=f;b=this.getObjectProjection2D(h);screenParticles.particles.CreateVehicleSmoke(b.x-this.activeViewportCenter.x,b.y-this.activeViewportCenter.y,1);this.busInCollisionWithOtherBuses(a)&&(soundManager.playSound("vehicle_hit"),a.position.x-=e,a.position.z-=f,a.collided=!0,null!=a.reservedPreParkingSpot&&(e=a.reservedPreParkingSpot.IDX,this.prePreParkingSpots[e].spotFree=!0,this.preParkingSpots[e].spotFree=!0,this.parkingSpots[e].spotFree=!0),
e={func:BABYLON.CubicEase,mode:BABYLON.EasingFunction.EASINGMODE_EASEOUT},CommonAnimations.AnimateObjectProperty(a.position,"x",a.origPosition.x,350,e,1,!1,function(){}),CommonAnimations.AnimateObjectProperty(a.position,"y",a.origPosition.y,350,e,1,!1,function(){}),CommonAnimations.AnimateObjectProperty(a.position,"z",a.origPosition.z,350,e,1,!1,function(){a.collided=!1;screenGame.removeBusToMove(a)}.bind(this)));this.busInCollisionWithBorder(a)&&(soundManager.playSound("bus_engine"),this.removeBusToMove(a),
this.busesToPark.push(a),a.testCollisions=!1)}},isItParkingSpot:function(a){for(var b=0;b<this.parkingSpots.length;b++)if(a==this.parkingSpots[b])return!0;return!1},freeParkingSpot:function(a){if(null!=a.parkedBus){soundManager.playSound("completed_1");var b=a.parkedBus;a.parkedBus=null;this.prePreParkingSpots[a.IDX].spotFree=!0;this.preParkingSpots[a.IDX].spotFree=!0;this.parkingSpots[a.IDX].spotFree=!0;b.parkingSpot=null;b.rotation.y+=DegToRad(180);this.closeRoofBus3d(b);this.busesToGo.push(b);
...
50*Resolution.SCALE;this.onResize();this.btnPay.isVisible=!inlHelper.rewardAds.active||!isAdReady();this.imgPayAd.isVisible=inlHelper.rewardAds.active&&isAdReady();this.btnFree.isVisible=inlHelper.rewardAds.active&&isAdReady();this.SCORE=0;this.setPrice(PRICE_NEW_SPOT);var b={func:BABYLON.CircleEase,mode:BABYLON.EasingFunction.EASINGMODE_EASEOUT};CommonAnimations.AnimateObjectProperty(this.guiRoot,"topInPixels",0,SCENE_TRANSITION_DURATION,b,1,!1);CommonAnimations.AnimateObjectProperty(this.guiRoot,
"alpha",1,SCENE_TRANSITION_DURATION,b,1,!1,function(){null!=a&&a();screenPurchaseSpot.enableControls()}.bind(this))},beforeRender:function(){},onResize:function(){if(this.guiRoot.isVisible){var a=engine.getRenderWidth(),b=engine.getRenderHeight();this.imgBackground.resize(a,b);a>=b?this.pnlPurchaseSpot.scaleTo(.7*Resolution.SCALE):(this.pnlPurchaseSpot.scaleTo(1*Resolution.SCALE),1100*this.pnlPurchaseSpot.scaleY>b&&this.pnlPurchaseSpot.scaleTo(b/1100));this.pnlPurchaseSpot.topInPixels=40*Resolution.SCALE;
this.resizeShadows()}},resizeShadows:function(){var a=this.txtTitle._fontSize._value/55;this.txtTitle.shadowOffsetX=getShadowOffs(0);this.txtTitle.shadowOffsetY=getShadowOffs(5*a);a=this.txtStuffDesc._fontSize._value/26;this.txtStuffDesc.shadowOffsetX=getShadowOffs(0);this.txtStuffDesc.shadowOffsetY=getShadowOffs(5*a);this.txtStuffDesc.outlineWidth=5*a;a=this.btnFree.children[1]._fontSize._value/35;this.btnFree.children[1].shadowOffsetX=getShadowOffs(0);this.btnFree.children[1].shadowOffsetY=getShadowOffs(4*
a);this.btnFree.children[1].outlineWidth=4*a}};var ScreenLevelCompleted=function(a){ScreenLevelCompleted.instance=this;this.create(a)};ScreenLevelCompleted.instance=null;
...
2,1.3);Buttons.enabled=!1;ActiveLevel++;SavedGame=null;GameData.Save();screenGame.resetGame();screenGame.updateData();soundManager.playMusic("music_ingame");screenGame.guiRoot.isVisible=!0;screenLevelCompleted.hideScene(function(){activeScene.gameRunning=!0;activeScene.gamePaused=!1;screenGame.enableControls();Buttons.enabled=!0})},onNextLevelPressed:function(){Buttons.enabled&&(inlHelper.ads.triggerAdPoint({adType:AD_TYPES.GAME_OVER}),Buttons.enabled=!1,soundManager.playSound("button"),adinplay_onAdStarted=
...
updateTexts:function(){this.txtTitle.text=STR("LEVEL")+" "+(ActiveLevel+1);this.txtCompleted.text=STR("COMPLETED");this.btnDismiss.children[1].text=STR("CONTINUE");var a=this.btnClaim.children[1]._fontSize._value/50;this.btnClaim.children[1].lineSpacing=-10*a;this.btnClaim.children[1].topInPixels=-10*a;0<this.btnClaim.children[1].text.indexOf("\n")&&(this.btnClaim.children[1].topInPixels=-5*a)},updateData:function(){},onDismissPressed:function(){Buttons.enabled&&(soundManager.playSound("button"),
Buttons.enabled=!1,screenLevelCompletedADs._claimRewardAndStartNextLevel(screenLevelCompletedADs.SCORE))},onClaimPressed:function(){Buttons.enabled&&(soundManager.playSound("button"),Buttons.enabled=!1,this.resultPriceClaimed=!0,RewardAds.showRewAd(activeScene.scene,function(){screenLevelCompletedADs._claimRewardAndStartNextLevel(screenLevelCompletedADs.SCORE*screenLevelCompletedADs.scoreMultiply)},function(){Buttons.enabled=!0;screenLevelCompletedADs.resultPriceClaimed=!1},this))},_claimRewardAndStartNextLevel:function(a){var b=
this.btnClaim.transformedMeasure;screenTopPanel.animateEarnedCoins(a,b.left+b.width/2-engineRenderWidth/2,b.top+b.height/2-engineRenderHeight/2,1.3);Buttons.enabled=!1;ActiveLevel++;SavedGame=null;GameData.Save();screenGame.resetGame();screenGame.updateData();soundManager.playMusic("music_ingame");screenGame.guiRoot.isVisible=!0;screenLevelCompletedADs.hideScene(function(){activeScene.gameRunning=!0;activeScene.gamePaused=!1;screenGame.enableControls();Buttons.enabled=!0})},enableControls:function(){enableButton(this.btnClaim)},
disableControls:function(){disableButton(this.btnClaim);disableButton(this.btnDismiss)},hideScene:function(a){void 0===a&&(a=null);this.disableControls();activeScene.scene.animationTimeScale=1;activeScene.gamePaused=!1;var b={func:BABYLON.CircleEase,mode:BABYLON.EasingFunction.EASINGMODE_EASEIN};CommonAnimations.AnimateObjectProperty(this.guiRoot,"topInPixels",-50*Resolution.SCALE,SCENE_TRANSITION_DURATION,b,1,!1);CommonAnimations.AnimateObjectProperty(this.guiRoot,"alpha",0,SCENE_TRANSITION_DURATION,
b,1,!1,function(){screenLevelCompletedADs.guiRoot.isVisible=!1;null!=a&&a()})},showScene:function(a){void 0===a&&(a=null);this.disableControls();this.guiRoot.alpha=0;this.guiRoot.isVisible=!0;this.guiRoot.topInPixels=50*Resolution.SCALE;this.onResize();this.updateTexts();this.resultPriceClaimed=!1;this.muliplyArrowOffset=0;this.scoreMultiply=1;this.SCORE=0;disableButton(this.btnDismiss);this.btnDismiss.alpha=0;this.btnDismiss.isVisible=!1;this.anmtblDismissButton=null;var b={func:BABYLON.CircleEase,
mode:BABYLON.EasingFunction.EASINGMODE_EASEOUT};CommonAnimations.AnimateObjectProperty(this.guiRoot,"topInPixels",0,SCENE_TRANSITION_DURATION,b,1,!1);CommonAnimations.AnimateObjectProperty(this.guiRoot,"alpha",1,SCENE_TRANSITION_DURATION,b,1,!1,function(){null!=a&&a();setTimeout(function(){screenLevelCompletedADs.btnDismiss.isVisible=!0;screenLevelCompletedADs.anmtblDismissButton=CommonAnimations.AnimateObjectProperty(screenLevelCompletedADs.btnDismiss,"alpha",1,SCENE_TRANSITION_DURATION,BABYLON.CubicEase,
2,!1,function(){enableButton(screenLevelCompletedADs.btnDismiss)})}.bind(this),1500);var e={func:BABYLON.CircleEase,mode:BABYLON.EasingFunction.EASINGMODE_EASEIN};CommonAnimations.AnimateObjectProperty(this,"SCORE",getLevelReward(ActiveLevel),150,e,1,!1,null);screenLevelCompletedADs.enableControls()}.bind(this))},beforeRender:function(){this.pnlRoot.isVisible&&(this.updateShines(),this.updateMultiplyArrow())},updateShines:function(){this.imgShine1.rotation+=DegToRad(.4)*activeScene.getCpuSpeedMul();
this.imgShine2.rotation-=DegToRad(.4)*activeScene.getCpuSpeedMul()},updateMultiplyArrow:function(){if(!this.resultPriceClaimed){var a=activeScene.deltaTime/16.6666;this.imgMultiplyArrow.isVisible&&(this.muliplyArrowOffset+=a/40);a=Math.abs(this.muliplyArrowOffset%2);a=easeInOutSine(a);this.imgMultiplyArrow.leftInPixels=(a-.5)*(this.imgMultiplyBg.widthInPixels-50);a=Math.abs(Math.floor(1E3*(a-.5)));this.scoreMultiply=5;74<a&&(this.scoreMultiply=3);272<a&&(this.scoreMultiply=2);a=this.scoreMultiply*
this.SCORE;this.btnClaim.setText("+"+a)}},onResize:function(){if(this.guiRoot.isVisible){var a=engine.getRenderWidth(),b=engine.getRenderHeight();this.imgBackground.resize(a,b);a>b?this.pnlLevelCompletedADs.scaleTo(.8*Resolution.SCALE):(this.pnlLevelCompletedADs.scaleTo(1.2*Resolution.SCALE),1E3*this.pnlLevelCompletedADs.scaleY>b&&this.pnlLevelCompletedADs.scaleTo(b/1E3));this.pnlLevelCompletedADs.topInPixels=40*Resolution.SCALE;this.resizeShadows()}},resizeShadows:function(){var a=this.txtTitle._fontSize._value/
55;this.txtTitle.shadowOffsetX=getShadowOffs(0);this.txtTitle.shadowOffsetY=getShadowOffs(5*a);a=this.txtCompleted._fontSize._value/40;this.txtCompleted.shadowOffsetX=getShadowOffs(0);this.txtCompleted.shadowOffsetY=getShadowOffs(5*a);this.txtCompleted.outlineWidth=6*a;a=this.txtRewardValue._fontSize._value/50;this.txtRewardValue.shadowOffsetX=getShadowOffs(0);this.txtRewardValue.shadowOffsetY=getShadowOffs(5*a);this.txtRewardValue.outlineWidth=5*a;a=this.btnClaim.children[1]._fontSize._value/40;
this.btnClaim.children[1].shadowOffsetX=getShadowOffs(0);this.btnClaim.children[1].shadowOffsetY=getShadowOffs(2*a);this.btnClaim.children[1].outlineWidth=getShadowOffs(4*a);a=this.btnDismiss.children[1]._fontSize._value/35;this.btnDismiss.children[1].shadowOffsetX=getShadowOffs(0);this.btnDismiss.children[1].shadowOffsetY=getShadowOffs(2*a);this.btnDismiss.children[1].outlineWidth=getShadowOffs(4*a)}};var ScreenLevelFailed=function(a){ScreenLevelFailed.instance=this;this.create(a)};ScreenLevelFailed.instance=null;
...
this.guiRoot.alpha=0;this.guiRoot.isVisible=!0;this.guiRoot.topInPixels=50*Resolution.SCALE;this.onResize();this.SCORE=0;this.setPrice(PRICE_NEW_SPOT);this.btnFree.isVisible=inlHelper.rewardAds.active&&isAdReady();this.imgPayAd.isVisible=inlHelper.rewardAds.active&&isAdReady();this.btnPay.isVisible=!inlHelper.rewardAds.active||!isAdReady();var b={func:BABYLON.CircleEase,mode:BABYLON.EasingFunction.EASINGMODE_EASEOUT};CommonAnimations.AnimateObjectProperty(this.guiRoot,"topInPixels",0,SCENE_TRANSITION_DURATION,
...
100)},createRootPanel:function(a){this.pnlRoot=new BABYLON.GUI.Rectangle("ScreenSettings.pnlRoot");this.pnlRoot.transformCenterX=.5;this.pnlRoot.transformCenterY=.5;this.pnlRoot.isPointerBlocker=!1;this.pnlRoot.isHitTestVisible=!1;this.pnlRoot.leftInPixels=0;this.pnlRoot.topInPixels=0;this.pnlRoot.thickness=0;this.pnlRoot.highlightLineWidth=0;this.pnlRoot.clipContent=!1;this.pnlRoot.clipChildren=!1;this.pnlRoot.zIndex=10;a.addControl(this.pnlRoot);return this.pnlRoot},createSettingsPanel:function(a){this.pnlSettings=
new BABYLON.GUI.Rectangle("pnlSettings");this.pnlSettings.transformCenterX=.5;this.pnlSettings.transformCenterY=.5;this.pnlSettings.isPointerBlocker=!1;this.pnlSettings.isHitTestVisible=!1;this.pnlSettings.clipContent=!1;this.pnlSettings.clipChildren=!1;this.pnlSettings.widthInPixels=580;this.pnlSettings.heightInPixels=960;this.pnlSettings.thickness=0;this.pnlSettings.color="yellow";a.addControl(this.pnlSettings);this.pnlSettings.scaleTo=function(b){this.scaleX=this.scaleY=b};return this.pnlSettings},
updateSliders:function(a){var b=a?"music_button.png":"music_button_2.png",e=a?"volume_button.png":"volume_button_2.png";screenSettings.btnMusic.isEnabled=a;screenSettings.btnMusic.isHitTestVisible=a;screenSettings.btnMusic.children[0].color=a?"#FFFFFF":"#808080";SetImageFromSpritesheet(screenSettings.btnMusic.children[0],getAssetImage("pak1"),getAssetImageFrames("pak1"),b);b=screenSettings.sldrMusicVolume;b.isEnabled=a;b.imgSliderBg.color=a?"#FFFFFF":"#808080";b.imgSliderFill.color=a?"#FFFFFF":"#808080";
b.imgSlider.color=a?"#FFFFFF":"#808080";screenSettings.btnSounds.isEnabled=a;screenSettings.btnSounds.isHitTestVisible=a;screenSettings.btnSounds.children[0].color=a?"#FFFFFF":"#808080";SetImageFromSpritesheet(screenSettings.btnSounds.children[0],getAssetImage("pak1"),getAssetImageFrames("pak1"),e);e=screenSettings.sldrSoundsVolume;e.isEnabled=a;e.imgSliderBg.color=a?"#FFFFFF":"#808080";e.imgSliderFill.color=a?"#FFFFFF":"#808080";e.imgSlider.color=a?"#FFFFFF":"#808080"},createBackground:function(a){this.imgBackground=
new BABYLON.GUI.Image("imgBackground");this.imgBackground.transformCenterX=.5;this.imgBackground.transformCenterY=.5;this.imgBackground.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgBackground.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgBackground.domImage=AssetLoader.instance.loadedImages["main_bg.jpg"];this.imgBackground.isPointerBlocker=!1;this.imgBackground.isHitTestVisible=!0;this.imgBackground.widthInPixels=1920;this.imgBackground.heightInPixels=
1080;this.imgBackground.isVisible=!0;a.addControl(this.imgBackground);this.imgBackground.resize=function(b,e){b>e?(this.scaleY=this.scaleX=(b+5)/this.widthInPixels,this.heightInPixels*this.scaleY<e&&(this.scaleX=this.scaleY=(e+5)/this.heightInPixels)):(this.scaleX=this.scaleY=(e+5)/this.heightInPixels,this.widthInPixels*this.scaleX<b&&(this.scaleY=this.scaleX=(b+5)/this.widthInPixels))}},createTitle:function(a,b){this.imgTitleBg=new BABYLON.GUI.Image("imgTitleBg");this.imgTitleBg.transformCenterX=
...
6;this.txtTitle.shadowColor=TEXT_SHADOWS_ENABLED?"rgb(0,0,0, 0.5)":"rgba(80,80,80,0)";this.txtTitle.outlineColor="rgb(0,0,0)";this.txtTitle.outlineWidth=5;this.txtTitle.shadowBlur=10;a.addControl(this.txtTitle);this.btnClose=BABYLON.GUI.Button.CreateImageOnlyButton("btnClose");this.btnClose.children[0].transformCenterY=.5;this.btnClose.children[0].transformCenterX=.5;this.btnClose.children[0].horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.btnClose.children[0].verticalAlignment=
BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.btnClose.transformCenterX=.5;this.btnClose.transformCenterY=.5;this.btnClose.topInPixels=b-1;this.btnClose.leftInPixels=220;a.addControl(this.btnClose);SetImageFromSpritesheet(this.btnClose.children[0],getAssetImage("pak1"),getAssetImageFrames("pak1"),"button_close.png");ResetGuiButtonAppearance(this.btnClose,this.btnClose.children[0].sourceWidth,this.btnClose.children[0].sourceHeight);this.btnClose.onPointerClickObservable.add(this.onClosePressed)},
createBody:function(a,b){this.imgBodyBg=new BABYLON.GUI.Image("imgBodyBg");this.imgBodyBg.transformCenterX=.5;this.imgBodyBg.transformCenterY=.5;this.imgBodyBg.isPointerBlocker=!1;this.imgBodyBg.isHitTestVisible=!1;this.imgBodyBg.scaleX=this.imgBodyBg.scaleY=2;SetImageFromSpritesheet(this.imgBodyBg,getAssetImage("pak1"),getAssetImageFrames("pak1"),"bg_panel_blue.png");this.imgBodyBg.leftInPixels=0;this.imgBodyBg.topInPixels=b;a.addControl(this.imgBodyBg)},createLogo:function(a,b){this.imgLogoBg=new BABYLON.GUI.Image("imgLogoBg");
this.imgLogoBg.transformCenterX=.5;this.imgLogoBg.transformCenterY=.5;this.imgLogoBg.isPointerBlocker=!1;this.imgLogoBg.isHitTestVisible=!1;SetImageFromSpritesheet(this.imgLogoBg,getAssetImage("gametitle_en"),getAssetImageFrames("gametitle_en"));this.imgLogoBg.leftInPixels=0;this.imgLogoBg.topInPixels=b;a.addControl(this.imgLogoBg)},createMusicAndSoundsSettings:function(a,b){this.imgMusicBg=new BABYLON.GUI.Image("imgMusicBg");this.imgMusicBg.transformCenterX=.5;this.imgMusicBg.transformCenterY=.5;
this.imgMusicBg.isPointerBlocker=!1;this.imgMusicBg.isHitTestVisible=!1;SetImageFromSpritesheet(this.imgMusicBg,getAssetImage("pak1"),getAssetImageFrames("pak1"),"lang_bg_panel.png");this.imgMusicBg.leftInPixels=0;this.imgMusicBg.topInPixels=b-12;a.addControl(this.imgMusicBg);this.btnMusic=BABYLON.GUI.Button.CreateImageOnlyButton("btnMusic");this.btnMusic.leftInPixels=-175;this.btnMusic.topInPixels=b-12;a.addControl(this.btnMusic);SetImageFromSpritesheet(this.btnMusic.children[0],getAssetImage("pak1"),
getAssetImageFrames("pak1"),"music_button.png");ResetGuiButtonAppearance(this.btnMusic,this.btnMusic.children[0].sourceWidth,this.btnMusic.children[0].sourceHeight);this.btnMusic.onPointerClickObservable.add(this.onMusicPressed);this.sldrMusicVolume=createSliderControl(a,50,this.btnMusic.topInPixels,"volume_bar.png","volume_bar_fill.png","settings_bar_indicator.png");this.sldrMusicVolume.sliderGap=20;this.sldrMusicVolume.scaleX=this.sldrMusicVolume.scaleY=1;this.sldrMusicVolume.onValueChanged=function(e){1.5>
e&&(e=0);0<e&&(SavedMusicVolume=e);soundManager.setMusicVolume(e/100);0==e?SetImageFromSpritesheet(screenSettings.btnMusic.children[0],getAssetImage("pak1"),getAssetImageFrames("pak1"),"music_button_2.png"):SetImageFromSpritesheet(screenSettings.btnMusic.children[0],getAssetImage("pak1"),getAssetImageFrames("pak1"),"music_button.png")};this.imgSoundsBg=new BABYLON.GUI.Image("imgSoundsBg");this.imgSoundsBg.transformCenterX=.5;this.imgSoundsBg.transformCenterY=.5;this.imgSoundsBg.isPointerBlocker=!1;
this.imgSoundsBg.isHitTestVisible=!1;SetImageFromSpritesheet(this.imgSoundsBg,getAssetImage("pak1"),getAssetImageFrames("pak1"),"lang_bg_panel.png");this.imgSoundsBg.leftInPixels=0;this.imgSoundsBg.topInPixels=this.btnMusic.topInPixels+105;a.addControl(this.imgSoundsBg);this.btnSounds=BABYLON.GUI.Button.CreateImageOnlyButton("btnSounds");this.btnSounds.leftInPixels=this.btnMusic.leftInPixels;this.btnSounds.topInPixels=this.imgSoundsBg.topInPixels;a.addControl(this.btnSounds);SetImageFromSpritesheet(this.btnSounds.children[0],
getAssetImage("pak1"),getAssetImageFrames("pak1"),"volume_button.png");ResetGuiButtonAppearance(this.btnSounds,this.btnSounds.children[0].sourceWidth,this.btnSounds.children[0].sourceHeight);this.btnSounds.onPointerClickObservable.add(this.onSoundsPressed);this.sldrSoundsVolume=createSliderControl(a,this.sldrMusicVolume.leftInPixels,this.btnSounds.topInPixels,"volume_bar.png","volume_bar_fill.png","settings_bar_indicator.png");this.sldrSoundsVolume.sliderGap=20;this.sldrSoundsVolume.scaleX=this.sldrSoundsVolume.scaleY=
1;this.sldrSoundsVolume.scaleTo=function(e){};this.sldrSoundsVolume.onValueChanged=function(e){1.5>e&&(e=0);0<e&&(SavedSoundVolume=e);soundManager.setSoundsVolume(e/100);0==e?SetImageFromSpritesheet(screenSettings.btnSounds.children[0],getAssetImage("pak1"),getAssetImageFrames("pak1"),"volume_button_2.png"):SetImageFromSpritesheet(screenSettings.btnSounds.children[0],getAssetImage("pak1"),getAssetImageFrames("pak1"),"volume_button.png")}},createLanguageSettings:function(a,b){this.imgLanguageFlag=
new BABYLON.GUI.Image("imgLanguageBg");this.imgLanguageFlag.transformCenterX=.5;this.imgLanguageFlag.transformCenterY=.5;this.imgLanguageFlag.horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.imgLanguageFlag.verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.imgLanguageFlag.isPointerBlocker=!1;this.imgLanguageFlag.isHitTestVisible=!1;this.imgLanguageFlag.leftInPixels=0;this.imgLanguageFlag.topInPixels=b;a.addControl(this.imgLanguageFlag);SetImageFromSpritesheet(this.imgLanguageFlag,
getAssetImage("pak1"),getAssetImageFrames("pak1"),"flag_"+languages.language.toLowerCase()+".png");this.btnPrevLang=BABYLON.GUI.Button.CreateImageOnlyButton("btnPrevLang");this.btnPrevLang.children[0].transformCenterY=.5;this.btnPrevLang.children[0].transformCenterX=.5;this.btnPrevLang.children[0].horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.btnPrevLang.children[0].verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.btnPrevLang.transformCenterX=.5;this.btnPrevLang.transformCenterY=
.5;this.btnPrevLang.topInPixels=b;this.btnPrevLang.leftInPixels=-175;a.addControl(this.btnPrevLang);SetImageFromSpritesheet(this.btnPrevLang.children[0],getAssetImage("pak1"),getAssetImageFrames("pak1"),"arrow_left.png");ResetGuiButtonAppearance(this.btnPrevLang,this.btnPrevLang.children[0].sourceWidth,this.btnPrevLang.children[0].sourceHeight);this.btnPrevLang.thickness=0;this.btnPrevLang.color="red";this.btnPrevLang.onPointerClickObservable.add(this.onPrevLangPressed);this.btnNextLang=BABYLON.GUI.Button.CreateImageOnlyButton("btnNextLang");
this.btnNextLang.children[0].transformCenterY=.5;this.btnNextLang.children[0].transformCenterX=.5;this.btnNextLang.children[0].horizontalAlignment=BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_CENTER;this.btnNextLang.children[0].verticalAlignment=BABYLON.GUI.Control.VERTICAL_ALIGNMENT_CENTER;this.btnNextLang.transformCenterX=.5;this.btnNextLang.transformCenterY=.5;this.btnNextLang.topInPixels=b;this.btnNextLang.leftInPixels=-this.btnPrevLang.leftInPixels;a.addControl(this.btnNextLang);SetImageFromSpritesheet(this.btnNextLang.children[0],
getAssetImage("pak1"),getAssetImageFrames("pak1"),"arrow_right.png");ResetGuiButtonAppearance(this.btnNextLang,this.btnNextLang.children[0].sourceWidth,this.btnNextLang.children[0].sourceHeight);this.btnNextLang.thickness=0;this.btnNextLang.color="red";this.btnNextLang.onPointerClickObservable.add(this.onNextLangPressed)},updateTexts:function(){this.txtTitle.text=Str("SETTINGS");SetImageFromSpritesheet(this.imgLanguageFlag,getAssetImage("pak1"),getAssetImageFrames("pak1"),"flag_"+languages.language.toLowerCase()+
".png")},onMusicPressed:function(){Buttons.enabled&&0!=GameSnacks.audio.isEnabled()&&(soundManager.playSound("button"),0<screenSettings.sldrMusicVolume.value?(SavedMusicVolume=screenSettings.sldrMusicVolume.value,screenSettings.sldrMusicVolume.value=0):screenSettings.sldrMusicVolume.value=SavedMusicVolume)},onSoundsPressed:function(){Buttons.enabled&&0!=GameSnacks.audio.isEnabled()&&(soundManager.playSound("button"),0<screenSettings.sldrSoundsVolume.value?(SavedSoundVolume=screenSettings.sldrSoundsVolume.value,
screenSettings.sldrSoundsVolume.value=0):screenSettings.sldrSoundsVolume.value=SavedSoundVolume)},onFullscreenPressed:function(){Buttons.enabled&&(Buttons.enabled=!1,soundManager.playSound("button"),fullscreenToggle(),Buttons.enabled=!0)},onQualityPressed:function(){Buttons.enabled&&(Buttons.enabled=!1,soundManager.playSound("button"),GameQuality=0==GameQuality?1:0,GameData.Save(),setGameResolutionByQuality(),onResize(),onResize(),screenSettings.updateQualityButton(),Buttons.enabled=!0)},onSurrenderPressed:function(){Buttons.enabled&&
(Buttons.enabled=!1,soundManager.playSound("button"),screenSettings.hideScene(),screenForfConfirm.showScene(function(){Buttons.enabled=!0}))},onClosePressed:function(){Buttons.enabled&&(Buttons.enabled=!1,soundManager.playSound("button"),screenTopPanel.showScene(),screenSettings.hideScene(function(){activeScene.gamePaused=screenSettings.wasPaused;screenPurchaseBooster.guiRoot.isVisible?screenPurchaseBooster.enableControls():screenGame.enableControls();Buttons.enabled=!0}))},onNextLangPressed:function(){if(Buttons.enabled){Buttons.enabled=
!1;soundManager.playSound("button");var a=LANGUAGES.indexOf(Languages.instance.language);a++;a>LANGUAGES.length-1&&(a=0);Languages.instance.language=LANGUAGES[a];SelectedLanguage=Languages.instance.language;GameData.Save();activeScene.updateTexts();Buttons.enabled=!0}},onPrevLangPressed:function(){if(Buttons.enabled){Buttons.enabled=!1;soundManager.playSound("button");var a=LANGUAGES.indexOf(Languages.instance.language);a--;0>a&&(a=LANGUAGES.length-1);Languages.instance.language=LANGUAGES[a];SelectedLanguage=
Languages.instance.language;GameData.Save();activeScene.updateTexts();Buttons.enabled=!0}},enableControls:function(){enableButton(this.btnSounds);enableButton(this.btnMusic);enableButton(this.btnNextLang);enableButton(this.btnPrevLang);this.sldrSoundsVolume.isEnabled=!0;this.sldrMusicVolume.isEnabled=!0},disableControls:function(){disableButton(this.btnSounds);disableButton(this.btnMusic);disableButton(this.btnNextLang);disableButton(this.btnPrevLang);this.sldrSoundsVolume.isEnabled=!1;this.sldrMusicVolume.isEnabled=
!1},hideScene:function(a){void 0===a&&(a=null);this.disableControls();activeScene.scene.animationTimeScale=1;var b={func:BABYLON.CircleEase,mode:BABYLON.EasingFunction.EASINGMODE_EASEIN};CommonAnimations.AnimateObjectProperty(this.guiRoot,"topInPixels",-50*Resolution.SCALE,SCENE_TRANSITION_DURATION,b,1,!1);CommonAnimations.AnimateObjectProperty(this.guiRoot,"alpha",0,SCENE_TRANSITION_DURATION,b,1,!1,function(){activeScene.scene.activeCameras=screenSettings.savedActiveCameras;activeScene.scene.activeCamera=
screenSettings.savedActiveCamera;activeScene.scene.cameraToUseForPointers=screenSettings.savedCameraToUseForPointers;screenSettings.guiRoot.isVisible=!1;null!=a&&a()})},showScene:function(a){void 0===a&&(a=null);this.guiRoot.alpha=0;this.guiRoot.isVisible=!0;this.guiRoot.topInPixels=50*Resolution.SCALE;this.sldrMusicVolume.value=100*soundManager.musicVolume;this.sldrSoundsVolume.value=100*soundManager.soundVolume;this.enableControls();this.onResize();var b={func:BABYLON.CircleEase,mode:BABYLON.EasingFunction.EASINGMODE_EASEOUT};
CommonAnimations.AnimateObjectProperty(this.guiRoot,"topInPixels",0,SCENE_TRANSITION_DURATION,b,1,!1);CommonAnimations.AnimateObjectProperty(this.guiRoot,"alpha",1,SCENE_TRANSITION_DURATION,b,1,!1,function(){activeScene.scene.animationTimeScale=0;null!=a&&a()})},beforeRender:function(){},onResize:function(){if(this.guiRoot.isVisible){var a=engine.getRenderWidth(),b=engine.getRenderHeight();this.imgBackground.resize(a,b);a>b?this.pnlSettings.scaleTo(.8*Resolution.SCALE):(this.pnlSettings.scaleTo(1.2*
Resolution.SCALE),1E3*this.pnlSettings.scaleY>b&&this.pnlSettings.scaleTo(b/1E3));this.resizeShadows()}},resizeShadows:function(){var a=this.txtTitle._fontSize._value/50;this.txtTitle.shadowOffsetX=getShadowOffs(0);this.txtTitle.shadowOffsetY=getShadowOffs(5*a)}};var ScreenParticles=function(a){ScreenParticles.instance=this;this.create(a)};ScreenParticles.instance=null;
