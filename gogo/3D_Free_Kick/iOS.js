...
var iOSjs	= new function()
{
	...
	this.getNormalWindowSize	= function()
	{
		...
		if(typeof(window.GameInterface.innerWidth) == "number")
		{
			//	non-IE
			width	= window.GameInterface.innerWidth;
			height	= window.GameInterface.innerHeight;
		}
	...
	this.getMaxSize	= function()
	{
		...
		if(this.isiOSDevice())
		{
			...
			if(ua.indexOf("iPad") > -1)
			{
				width = window.GameInterface.innerWidth || document.documentElement.clientWidth || document.body.clientWidth;
				height = window.GameInterface.innerHeight || document.documentElement.clientHeight || document.body.clientHeight;
			}
		}
		else
		{
