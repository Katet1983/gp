...
function CSpriteLibrary(){
    ...
    this.addSprite = function( szKey, szPath ){
        ...
        _oLibSprites[szKey] = _oSpritesToLoad[szKey] = { szPath:szPath, oSprite: new Image() ,bLoaded:false};
        _iNumSprites++;
    ...
    this.unloadSprite = function(szKey){
        delete _oLibSprites[szKey];
        delete _oSpritesToLoad[szKey];
    };
