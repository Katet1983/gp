    ...
    class App extends Phaser.Game {
        constructor() {
            ...
            SDK_INTERFACE_HELPERS.GameSnacks.audio.subscribe(isEnabled => {
                isEnabled ? src.SoundController.instance.resumeSounds() : src.SoundController.instance.pauseSounds();
            });
        }
        navigateToSponsor() {}
        showAd(timeout = 0) {}
...
if (typeof document.addEventListener === "undefined" || typeof document[hidden] === "undefined") {
    ...
    if(window.famobi.hasFeature("visibility_change")) {
        ...
        tweenAppearing(firstTime) {
            ...
            if (!firstTime) {
                ...
                this.game.add.tween(this)
                    .to({ alpha: this.defaultAlpha }, 2000, Phaser.Easing.Linear.None, true);
            }
        }
    ...
    class GameplayBackgroundManager extends Phaser.Group {
        ...
        startAppearingTween() {
            ...
            this.game.add.tween(this.perfectLine)
                .to({ alpha: this.perfectLineDefaultAlpha, y: this.state.windowBounds.height - src.Settings.PERFECT_LINE_MARGIN_BOTTOM }, 350, Phaser.Easing.Linear.None, true)
                .onComplete.add(() => {
                this.resize();
            });
        }
        blinkPerfectLine() {
            ...
            this.game.add.tween(this.perfectLine)
                .to({ alpha: this.perfectLineDefaultAlpha }, 200, Phaser.Easing.Linear.None, true, 0);
        }
        /**
         * DESTROY
         */
    ...
    class HeartManager extends Phaser.Group {
        ...
        pickupHeartAt(x, y) {
            ...
            this.game.add.tween(this.heartIcon)
                .to({ x: this.level.windowBounds.centerX, y: this.getHeartYPosition() }, 500, Phaser.Easing.Linear.None, true);
            this.game.add.tween(this.heartIcon.scale)
                .to({ x: this.getHeartTargetScale(), y: this.getHeartTargetScale() }, 500, Phaser.Easing.Linear.None, true);
        }
            ...
            if (this.hasHeart) {
                ...
                this.game.time.events.add(delay, () => {
                    ...
                    this.game.add.tween(this.background)
                        .to({ alpha: 0.8 }, 600, Phaser.Easing.Linear.None, true, 300)
                        .onComplete.add(() => {
                        this.game.add.tween(this.heartIcon)
                            .to({ x: this.level.windowBounds.centerX, y: this.level.windowBounds.centerY }, 500, Phaser.Easing.Sinusoidal.Out, true);
                        this.game.add.tween(this.heartIcon.scale)
                            .to({ x: 1.5, y: 1.5 }, 500, Phaser.Easing.Sinusoidal.Out, true)
                            .onComplete.add(() => {
        ...
        moveHeartIconUp() {
            this.game.add.tween(this.heartIcon)
                .to({ y: this.getHeartYPosition() }, 500, Phaser.Easing.Linear.None, true);
        }
        animateHeartDisappearing() {
            this.game.add.tween(this.heartIcon.scale)
                .to({ x: 1.65, y: 1.65 }, 450, Phaser.Easing.Linear.None, true)
                .onComplete.add(() => {
                ...
                this.game.add.tween(this.heartBackground.scale)
                    .to({ x: 1.8, y: 1.8 }, 500, Phaser.Easing.Linear.None, true, 300);
                this.game.add.tween(this.heartBackground)
                    .to({ alpha: 0 }, 500, Phaser.Easing.Linear.None, true, 500);
                this.game.add.tween(this.heartIcon.scale)
                    .to({ x: 0, y: 0 }, 400, Phaser.Easing.Back.In, true, 0);
            });
        }
        hide() {
            this.game.add.tween(this.background)
...
(function (src) {
    class TileManager extends Phaser.Group {
        ...
        startLevel() {
            ...
            this.game.add.tween(this)
                .to({ y: this.y + 100 }, 600, Phaser.Easing.Sinusoidal.Out, true);
        ...
        stopPlayback(smoothly) {
            if (this.tileSpeedManager.isStarted) {
                ...
                if (!firstTile) {
                    ...
                    if (smoothly) {
                        this.game.add.tween(this.tilesContainer).to({ y: this.tilesContainer.y + displacement }, 400, Phaser.Easing.Sinusoidal.Out, true)
        ...
        rewindTile(tile) {
            if (!src.Settings.GOD_MODE && this.tileSpeedManager.isStarted) {
                ...
                this.game.add.tween(this.tilesContainer).to({ y: this.tilesContainer.y + displacement }, 600, Phaser.Easing.Sinusoidal.Out, true);
            }
        }
        recoverGame() {
            this.tileSpeedManager.stopPlayback();
            ...
            if (!firstTile) {
                ...
                const startingTile = this.tileBuilder.createStartingTile(firstTile.tilePosition, firstTile.y + src.Settings.TILE_HEIGHT);
                const displacement = this.getStartingTilePosition() - (startingTile ? src.Settings.TILE_HEIGHT : 0) - firstTile.getScreenY() + this.getScreenHeight();
                let tween = this.game.add.tween(this.tilesContainer).to({ y: this.tilesContainer.y + displacement }, 400, Phaser.Easing.Sinusoidal.Out, true);
                this.resumePlayback();
            }
        }
        /**
...
(function (src) {
    class UIManager extends Phaser.Group {
        ...
        buildContent() {
            ...
            const adBreakPause = () => {
                window.famobi.showInterstitialAd("button:level:pause", () => {
                    this.settingsClicked();
                });
            };

            this.buttonSettings = this.buttonsContainer.add(src.ButtonUtils.createTwoFramesButton(src.Settings.GAME_ATLAS, 'buttonSettings', 570, 75, 1, adBreakPause, this));
        }
        /**
         * PUBLIC
         */
        ...
        hideProgressBar() {
            if (!this.isProgressBarHidden) {
                ...
                this.game.add.tween(this)
                    .to({ y: this.level.windowBounds.top - 35 }, 500, Phaser.Easing.Linear.None, true);
                ...
                this.game.add.tween(this.buttonsContainer)
                    .to({ y: 37 }, 500, Phaser.Easing.Linear.None, true);
                this.keyHelpers.forEach(keyHelper => this.game.add.tween(keyHelper)
                    .to({ y: this.level.windowBounds.height - 5 }, 500, Phaser.Easing.Linear.None, true));
            }
        }
...
(function (src) {
    class TilesPanel extends Phaser.Group {
        ...
        buildTiles() {
            ...
            let tileModel = { notes: [], nextPossibleTileStart: 0 };
    ...
    class Tile extends Phaser.Group {
        ...
        showRewardText(y) {
            ...
            this.game.add.tween(this.rewardText)
                .to({ alpha: 0 }, duration * 1.6, Phaser.Easing.Exponential.In, true);
            this.game.add.tween(this.rewardText)
                .to({ y: src.Settings.IS_DESKTOP ? y - 70 : y - 70 / duration * 400 }, duration * 1.05, Phaser.Easing.Back.Out, true);
            this.game.add.tween(this.rewardText.scale)
                .to({ x: targetScale, y: targetScale }, duration, Phaser.Easing.Back.Out, true);
        }
        /**
         * PUBLIC
         */
    ...
    class DefeatTile extends src.Tile {
        ...
        buildContent(customHeight) {
            ...
            this.game.add.tween(this.tile)
                .to({ alpha: 0.1 }, 250, Phaser.Easing.Circular.Out, true, 0, 3, true)
                .onComplete.add(() => {
                this.isPressed = true;
            });
        }
...
(function (src) {
    class HeartTile extends src.Tile {
        ...
        playTile() {
            ...
            this.game.add.tween(this.heartBackground.scale)
                .to({ x: 1.25, y: 1.25 }, 450, Phaser.Easing.Linear.None, true);
            this.game.add.tween(this.heartBackground)
                .to({ alpha: 0 }, 450, Phaser.Easing.Linear.None, true);
        }
        handleInputDown(pointer) {
        ...
        finishPlaying() {
            if (this.isPressed && !this.wasReleased) {
                ...
                this.game.add.tween(this.tilesContainer)
                    .to({ alpha: 0.25 }, 150, Phaser.Easing.Linear.None, true);
    ...
    class ShortTile extends src.Tile {
        ...
        handleInputDown(pointer) {
            ...
            if (!this.isPressed && this.hitsPoint(touchPoint)) {
                ...
                this.pointerDownLocalPosition = new Phaser.Point(this.pointerDownPosition.x - this.getScreenX(), this.pointerDownPosition.y - this.getScreenY());
                this.game.add.tween(this.tileTransition)
                    .to({ alpha: 0 }, this.transitionDuration, Phaser.Easing.Circular.Out, true);
                this.game.add.tween(this.tilesTail)
                    .to({ alpha: 0 }, 150, Phaser.Easing.Linear.None, true)
                    .onComplete.add(() => this.tilesTail.visible = false);
                if (this.level.windowBounds.down - touchPoint.y <= src.Settings.TILE_HEIGHT * (1 + src.Settings.TILE_TAP_BONUS_DISTANCE_FACTOR)) {
    ...
    class TileSpeedManager {
        ...
        startPlaybackSmoothly() {
            ...
            src.App.instance.add.tween(this)
                .to({ slowdownMultiplier: 1 }, Math.pow(this.bpm / 100, 1.2) * 100 * 10, Phaser.Easing.Quadratic.Out, true);
        }
        getSpeedUpFactor() {
    ...
    class ScoreManager {
        ...
        initScores(scores) {
            ...
            src.SongStorage.instance.songs.forEach(song => {
                this.scores[song.name] = { "actual": 0, "total": 0 };
...
(function (src) {
    class SoundController {
        ...
        init() {
            ...
            src.App.instance.sound.mute = src.LocalStorageController.instance.isMuted();

            if(typeof GameSnacks !== "undefined") {
                src.App.instance.sound.mute = !SDK_INTERFACE_HELPERS.GameSnacks.audio.isEnabled();
            }
        }
        /**
         * PAUSE/RESUME SOUND
...
(function (src) {
    class MainMenu extends src.AutoResizeableState {
        ...
        buildContent() {
            ...
            const adBreakBrowse = isLevels => {
                window.famobi.showInterstitialAd("button:main:" + (isLevels ? "levelselect" : "settings"), () => {
                    isLevels ? this.levelsClicked() : this.settingsClicked();
                }, "browse");
            };

            this.buttonPlay = this.addChild(src.ButtonUtils.createTwoFramesButton(src.Settings.GAME_ATLAS, 'buttonPlay', this.originalBounds.centerX, this.originalBounds.centerY, 1.15, adBreakStart, this));
            this.buttonLevels = this.addChild(src.ButtonUtils.createTwoFramesButton(src.Settings.GAME_ATLAS, 'buttonLevelsMainMenu', this.originalBounds.centerX, this.originalBounds.centerY + 230, 1, adBreakBrowse.bind(this, true), this));
            this.buttonSettings = this.addChild(src.ButtonUtils.createTwoFramesButton(src.Settings.GAME_ATLAS, 'buttonSettingsMainMenu', this.originalBounds.centerX, this.originalBounds.centerY + 230, 1, adBreakBrowse.bind(this, false), this));
            if (src.Settings.ENABLE_API) {
                ...
                this.buttonMore.input.useHandCursor = false;
...
(function (src) {
    class SongsMenu extends src.AutoResizeableState {
        ...
        buildContent() {
            ...
            const adBreakBrowse = () => {
                window.famobi.showInterstitialAd("button:levelselect:home", () => {
                     this.backClicked();
                });
            };

            this.buttonBack = this.buttonBackContainer.add(src.ButtonUtils.createTwoFramesButton(src.Settings.GAME_ATLAS, 'buttonHomeMainMenu', 0, 4, 0.68, adBreakBrowse, this));
...
(function (src) {
    class TransitionScreen extends Phaser.Group {
        ...
        blink(callback = null) {
            ...
            this.resize();
            this.game.add.tween(this.background)
                .to({ alpha: 1 }, 230, Phaser.Easing.Quadratic.Out, true)
                .onComplete.add(() => {
                if (callback) {
                    callback();
                }
                ...
                this.game.add.tween(this.background)
                    .to({ alpha: 0 }, 140, Phaser.Easing.Linear.None, true)
        ...
        show() {
            ...
            this.resize();
            this.game.add.tween(this.background)
                .to({ alpha: 1 }, 100, Phaser.Easing.Quadratic.Out, true)
...
(function (src) {
    class HoldAnimation extends Phaser.Group {
        ...
        startTweening() {
            ...
            this.y = this.startY;
            this.game.add.tween(this)
                .to({ alpha: 1 }, 600, Phaser.Easing.Sinusoidal.Out)
                .start()
                .onComplete.add(() => {
                if (this.downAnimation) {
        ...
        holdAndUp() {
            this.game.add.tween(this)
                .to({ y: this.startY - 40 }, 700, Phaser.Easing.Linear.None, true)
...
(function (src) {
    class TutorialKeyHelpers extends Phaser.Group {
        ...
        buildContent() {
            this.keys = [
                { key: this.add(src.TextUtils.getBitmapText("F", src.Settings.TILE_WIDTH * -1.5, -25, 52)), state: false, timer: 0 },
                { key: this.add(src.TextUtils.getBitmapText("G", src.Settings.TILE_WIDTH * -0.5, -25, 52)), state: false, timer: 0 },
                { key: this.add(src.TextUtils.getBitmapText("H", src.Settings.TILE_WIDTH * 0.5, -25, 52)), state: false, timer: 0 },
                { key: this.add(src.TextUtils.getBitmapText("J", src.Settings.TILE_WIDTH * 1.5, -25, 52)), state: false, timer: 0 }
            ];
        ...
        animateHit(id) {
            if (this.keys[id]) {
                this.game.add.tween(this.keys[id].key.scale)
                    .to({ x: 1.7, y: 1.7 }, 90, Phaser.Easing.Linear.None, true, 0, 0, true);
            }
        }
        destroy() {
            super.destroy();
    ...
    class TutorialPresenter extends Phaser.Group {
        ...
        tweenGreenZone() {
            ...
            this.game.add.tween(this.iconGood.scale)
                .to({ x: 1.3, y: 1.3 }, 2100, Phaser.Easing.Linear.None, true, 0);
            this.game.add.tween(this.backgroundGreen)
                .to({ alpha: 0.6 }, 350, Phaser.Easing.Linear.None, true, 0, 2, true)
                .onComplete.add(() => {
        ...
        tweenDisappearing() {
            this.game.add.tween(this.iconGood.scale)
                .to({ x: 0, y: 0 }, 450, Phaser.Easing.Back.In, true);
            this.game.add.tween(this.iconNormal.scale)
                .to({ x: 0, y: 0 }, 450, Phaser.Easing.Back.In, true, 150);
            this.game.add.tween(this.iconBad.scale)
                .to({ x: 0, y: 0 }, 450, Phaser.Easing.Back.In, true, 300);
            this.game.add.tween(this.iconGood)
                .to({ alpha: 0 }, 450, Phaser.Easing.Linear.None, true);
            this.game.add.tween(this.iconNormal)
                .to({ alpha: 0 }, 450, Phaser.Easing.Linear.None, true, 150);
            this.game.add.tween(this.iconBad)
                .to({ alpha: 0 }, 450, Phaser.Easing.Linear.None, true, 300)
                .onComplete.add(() => {
    ...
    class TutorialUIManager extends Phaser.Group {
        ...
        showSign(score) {
            ...
            this.game.add.tween(this.sign)
                .to({ alpha: 0 }, 650, Phaser.Easing.Circular.In, true);
            this.game.add.tween(this.sign.scale)
                .to({ x: 0.75, y: 0.75 }, 550, Phaser.Easing.Back.Out, true);
        }
        startBlinking(position) {
            ...
            if (!this.isExpanded) {
                ...
                this.songs.forEach((songPanel, index) => {
                    this.game.add.tween(songPanel)
                        .to({ y: src.Settings.ALBUM_PANEL_HEIGHT + 5 + (src.Settings.SONG_PANEL_HEIGHT + src.Settings.DISTANCE_BETWEEN_SONGS) * index }, 400, Phaser.Easing.Quartic.Out, true);
                });
            }
        }
        collapse() {
            if (this.isExpanded) {
                ...
                this.songs.forEach(songPanel => {
                    this.game.add.tween(songPanel)
                        .to({ y: this.songPanelCollapsedY }, tweenDuration, Phaser.Easing.Sinusoidal.In, true);
                });
...
(function (src) {
    class ShineEffect extends Phaser.Sprite {
        ...
        restartTweens() {
            ...
            this.scale.set(0, 0);
            this.game.add.tween(this)
                .to({ alpha: 1 }, 2 * duration, Phaser.Easing.Linear.None, true, 0, 0, false)
                .onComplete.add(() => {
                this.restartTweens();
            });
            this.game.add.tween(this.scale)
                .to({ x: targetScale, y: targetScale }, duration, Phaser.Easing.Cubic.In, true, 0, 0, true);
            this.game.add.tween(this)
                .to({ angle: Math.random() * 360 * this.game.rnd.sign() }, 2 * duration, Phaser.Easing.Linear.None, true, 0, 0, false);
        }
    }
    ...
    class AlbumsManager extends Phaser.Group {
        ...
        openAlbum(album) {
            ...
            this.game.add.tween(this.albumsContainer)
                .to({ y: targetY }, 400, Phaser.Easing.Quadratic.Out, true);
        }
        closeAlbum(album) {
            album.collapse();
            ...
            this.game.add.tween(this.albumsContainer)
                .to({ y: targetY }, 300, Phaser.Easing.Sinusoidal.In, true);
        }
        getUnlockedSongs() {
            let songs = [];
    ...
    class EndlessModePresenter extends Phaser.Group {
        ...
        show() {
            if (!this.isShown) {
                ...
                this.background.alpha = 0;
                this.game.add.tween(this.background)
                    .to({ alpha: 0.5 }, 700, Phaser.Easing.Linear.None, true, 300);
        ...
        animateStarsPanelDisappearing() {
            this.game.add.tween(this.panelsContainer)
                .to({ y: Math.max(this.level.windowBounds.top + 150, this.panelsContainer.y - 150) }, 1200, Phaser.Easing.Sinusoidal.Out, true)
        ...
        showInfinityIcon() {
            ...
            this.game.add.tween(this.infinityIcon.scale)
                .to({ x: 1, y: 1 }, 500, Phaser.Easing.Back.Out, true, 0)
                .onComplete.add(() => {
                this.game.add.tween(this.infinityIcon.scale)
                    .to({ x: 1.25, y: 1.25 }, 1600, Phaser.Easing.Linear.None, true)
        ...
        hide() {
            ...
            this.game.add.tween(this.infinityIcon.scale)
                .to({ x: 0, y: 0 }, 600, Phaser.Easing.Back.In, true, 0);
        }
    }
    ...
    class PresenterLine extends Phaser.Group {
        ...
        animateAppearing(delay) {
            ...
            let appearingTween = this.game.add.tween(this)
                .to({ x: 0 }, 300, Phaser.Easing.Linear.None, true, delay);
        ...
        animateDisappearing(delay) {
            this.game.add.tween(this)
                .to({ x: -this.presenterPanel.width }, 300, Phaser.Easing.Linear.None, true, delay);
            this.game.add.tween(this.presenterIcon)
                .to({ alpha: 0 }, 300, Phaser.Easing.Linear.None, true, delay);
            this.game.add.tween(this.presenterText)
                .to({ alpha: 0 }, 300, Phaser.Easing.Linear.None, true, delay);
        }
    }
...
(function (src) {
    class PresenterStarsPanel extends Phaser.Group {
        ...
        animateAppearing(numStars) {
            ...
            this.x = -this.presenterPanel.width;
            this.game.add.tween(this)
                .to({ x: 0 }, 350, Phaser.Easing.Linear.None, true, 350)
                .onComplete.add(() => {
                this.stars.forEach((star, index) => {
                    this.game.add.tween(star)
                        .to({ alpha: 1 }, 300, Phaser.Easing.Linear.None, true, 150 + index * 120);
                    this.game.add.tween(star.scale)
                        .to({ x: 1, y: 1 }, 300, Phaser.Easing.Back.Out, true, 150 + index * 120);
                });
            });
        }
        animateDisappearing() {
            this.game.add.tween(this)
                .to({ x: -this.presenterPanel.width }, 400, Phaser.Easing.Linear.None, true, 200);
            this.stars.forEach((star, index) => {
                this.game.add.tween(star)
                    .to({ alpha: 0 }, 300, Phaser.Easing.Linear.None, true, index * 120);
            });
        }
    }
    ...
    class SongPresenter extends Phaser.Group {
        ...
        show(titleText, authorText, bestScores, callback) {
            if (!this.isShown) {
                ...
                this.background.alpha = 0;
                this.game.add.tween(this.background)
                    .to({ alpha: 0.5 }, 500, Phaser.Easing.Linear.None, true, 300)
    ...
    class LevelProgressBar extends Phaser.Group {
        ...
        animateProgress() {
            this.game.add.tween(this.progressBar)
                .to({ width: Phaser.Math.clamp(src.ScoreManager.instance.getScoreProgress(), 0, 1) * this.level.windowBounds.width }, 300, Phaser.Easing.Circular.Out, true);
            ...
            this.stars.forEach((star, index) => {
                ...
                if (starEarned && star.frameName == 'levelProgressBarStar000' + this.color) {
                    this.game.add.tween(star.scale)
                        .to({ x: 1.3, y: 1.3 }, 100, Phaser.Easing.Circular.Out, true, 0, 0, true);
                }
    ...
    class SelectColorButton extends Phaser.Group {
        ...
        show(delay) {
            ...
            this.game.add.tween(this.panel)
                .to({ alpha: 1 }, 250, Phaser.Easing.Circular.Out, true, delay);
            this.game.add.tween(this.panel.scale)
                .to({ x: 1 }, 250, Phaser.Easing.Circular.Out, true, delay)
                .onComplete.add(() => {
        ...
        updateActivity(lazy = false) {
            if (this.color != src.BackgroundManager.instance.currentBackground) {
                this.game.add.tween(this.checkbox.scale)
                    .to({ x: 0, y: 0 }, 200, Phaser.Easing.Circular.In, true, 0);
            }
            else if (this.color == src.BackgroundManager.instance.currentBackground) {
                this.game.add.tween(this.checkbox.scale)
                    .to({ x: 1, y: 1 }, 200, Phaser.Easing.Back.Out, true, 0);
                if (!lazy) {
                    this.blinkEffect.alpha = 0.9;
                    this.game.add.tween(this.blinkEffect)
                        .to({ alpha: 0 }, 200, Phaser.Easing.Circular.Out, true, 0);
                }
            }
...
(function (src) {
    class SongPanel extends Phaser.Group {
        ...
        handleInputDown(sprite, pointer) {
            this.inputDownWorldPosition = new Phaser.Point(pointer.worldX, pointer.worldY);
            src.App.instance.add.tween(sprite.scale).to({ x: 0.95, y: 0.95 }, 40).start();
        }
        handleInputUp(sprite, pointer) {
            if (this.inputDownWorldPosition && this.inputDownWorldPosition.distance(new Phaser.Point(pointer.worldX, pointer.worldY)) < this.dragTreshold) {
                if (src.Settings.DEBUG_MODE && this.game.input.keyboard.isDown(Phaser.Keyboard.SHIFT)) {
                    ...
                    window.famobi.showInterstitialAd("button:levelselect:start", () => {
                        this.playPressed();
                    });
                }
            }
            src.App.instance.add.tween(sprite.scale).to({ x: 1, y: 1 }, 40).start();
            this.inputDownWorldPosition = null;
        }
        destroy() {
            this.removeListeners();
...
(function (src) {
    class ButtonUtils {
        ...
        static mouseOverHandler(caller) {
            src.App.instance.add.tween(caller.scale).to({ x: (caller["startScale"] || 1) * 1.02, y: (caller["startScale"] || 1) * 1.02 }, 100).start();
        }
        static mouseOutHandler(caller) {
            src.App.instance.add.tween(caller.scale).to({ x: (caller["startScale"] || 1), y: (caller["startScale"] || 1) }, 100).start();
        }
        static mouseDownHandler(caller) {
            src.SoundController.instance.playClickSound();
            src.App.instance.add.tween(caller.scale).to({ x: (caller["startScale"] || 1) * 0.98, y: (caller["startScale"] || 1) * 0.98 }, 50).to({ x: caller["startScale"] || 1, y: caller["startScale"] || 1 }, 50).start();
        }
    }
...
(function (src) {
    class LocalStorageController {
        ...
        save() {
            ...
            this.data["muted"] = src.App.instance.sound.mute;
        ...
        checkLocalStorageSupported() {
            try {
                this.isLocalStorageSupported = "famobi" in window && "localStorage" in window["famobi"] && window["famobi"]["localStorage"] !== null;
            }
            catch (e) {
                this.isLocalStorageSupported = false;
            }
...
(function (src) {
    class ResultsWindow extends src.BaseWindow {
        ...
        buildContent() {
            ...
            const adBreakStart = () => {
                window.famobi.showInterstitialAd("button:result:start", () => {
                    this.restartClicked();
                });
            };
            ...
            this.buttonRestart = this.plateContainer.add(src.ButtonUtils.createSimpleButton(src.Settings.GAME_ATLAS, 'buttonRestartWide', 0, 335, 0.95, adBreakStart, this));
            this.buttonNext = this.plateContainer.add(src.ButtonUtils.createSimpleButton(src.Settings.GAME_ATLAS, 'buttonNextWhite', 200, 335, 0.95, adBreakNext, this));
            /* STARS */
        ...
        animateContent() {
            ...
            this.game.add.tween(this.bottomContainer)
                .to({ alpha: 1 }, 300, Phaser.Easing.Circular.Out, true, 150);
            this.game.add.tween(this.bottomContainer)
                .to({ y: this.registrationPoint.y }, 300, Phaser.Easing.Sinusoidal.Out, true, 120);
            this.plateContainer.alpha = 0;
            this.plateContainer.y = this.plateContainer.y - 120;
            this.game.add.tween(this.plateContainer)
                .to({ alpha: 1 }, 300, Phaser.Easing.Circular.Out, true, 150);
            this.game.add.tween(this.plateContainer)
                .to({ y: this.plateContainer.y + 120 }, 300, Phaser.Easing.Sinusoidal.Out, true, 150);
            ...
            this.game.add.tween(this.recordIcon.scale)
                .to({ x: 1, y: 1 }, 350, Phaser.Easing.Back.Out, true, 200);
            this.game.add.tween(this.recordIcon)
                .to({ alpha: 1 }, 350, Phaser.Easing.Linear.None, true, 200);
        ...
        animateButton(button, duration, delay) {
            ...
            this.game.add.tween(button)
                .to({ alpha: 1 }, duration, Phaser.Easing.Cubic.Out, true, delay);
            this.game.add.tween(button.scale)
                .to({ x: button["startScale"] || 1, y: button["startScale"] || 1 }, duration, Phaser.Easing.Back.Out, true, delay);
        }
        animateText(text, initialValue, targetValue, duration, delay) {
            let currentValueHolder = { value: initialValue };
        ...
        tweenStar(star, startX, startY, endX, endY, delay, soundKey, emitter) {
            ...
            this.game.add.tween(star)
                .to({ x: endX, y: endY, alpha: 1 }, 250, Phaser.Easing.Sinusoidal.In, true, delay);
            this.game.add.tween(star.scale)
                .to({ x: 1, y: 1 }, 250, Phaser.Easing.Sinusoidal.In, true, delay)
...
(function (src) {
    class SettingsWindow extends src.BaseWindow {
        ...
        buildContent() {
            ...
            const adBreakStart = () => {
                window.famobi.showInterstitialAd("button:settings:restart", () => {
                    window.famobi_analytics.trackEvent("EVENT_LEVELFAIL", {levelName: "", reason: "quit"}).then(() => {
                        this.restartClicked();
                    });
                });
            };
            ...
            const adBreakBrowse = () => {
                window.famobi.showInterstitialAd("button:settings:browse", () => {
                    window.famobi_analytics.trackEvent("EVENT_LEVELFAIL", {levelName: "", reason: "quit"}).then(() => {
                        this.homeClicked();
                    });
                });
            ...
            this.buttonHome = this.buttonsContainer.add(src.ButtonUtils.createSimpleButton(src.Settings.GAME_ATLAS, 'buttonMenu', window.famobi.hasFeature("external_mute") ? -70 : -140, 0, 1, adBreakBrowse, this));
            this.buttonRestart = this.buttonsContainer.add(src.ButtonUtils.createSimpleButton(src.Settings.GAME_ATLAS, 'buttonRestart', window.famobi.hasFeature("external_mute") ? 70 : 0, 0, 1, adBreakStart, this));
        ...
        showMenuVersion() {
            ...
            this.buttonTutorial.x = window.famobi.hasFeature("external_mute") ? 0 : -72;
        ...
        tweenAppearing() {
            ...
            this.game.add.tween(this.plateContainer)
                .to({ alpha: 1 }, 300, Phaser.Easing.Circular.Out, true, 150);
            this.game.add.tween(this.plateContainer)
                .to({ y: this.plateContainer.y + 120 }, 300, Phaser.Easing.Sinusoidal.Out, true, 100);
            this.updateSoundButtons();
        }
        animateButton(button, duration, delay) {
            button.scale.set(0.5);
            ...
            this.game.add.tween(button)
                .to({ alpha: 1 }, duration, Phaser.Easing.Cubic.Out, true, delay);
            this.game.add.tween(button.scale)
                .to({ x: 1, y: 1 }, duration, Phaser.Easing.Back.Out, true, delay);
        ...
        hideGameContent() {
            ...
            if (currentState) {
                this.game.add.tween(currentState.container)
                    .to({ alpha: this.isGameplayVersion ? 0.1 : 0.0 }, 200, Phaser.Easing.Linear.None, true);
            }
        }
        restoreGameContent() {
            const currentState = this.game.state.getCurrentState();
