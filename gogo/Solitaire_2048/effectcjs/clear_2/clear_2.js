...
(lib.clear_card2 = function() {
	this.initialize(img.clear_card2);
...
(lib.clear_card2_sin = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// レイヤー_1
	this.instance = new lib.clear_card2();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.clear_card2_sin, new cjs.Rectangle(0,0,246,322), null);
...
if (reversed == null) { reversed = false; }
	...
	// レイヤー_3
	this.instance = new lib.clear_card2_sin();
...
// stage content:
(lib.clear_2 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(26).to({_off:false},0).wait(53).to({scaleX:0.9169},0).wait(1).to({scaleX:0.8339,x:319.95},0).wait(1).to({scaleX:0.7508,x:320},0).wait(1).to({scaleX:0.6677},0).wait(1).to({scaleX:0.5847,x:319.95},0).wait(1).to({scaleX:0.5016,x:320},0).wait(1).to({scaleX:0.4186},0).wait(1).to({scaleX:0.3355,x:319.95},0).wait(1).to({scaleX:0.2524,x:320},0).wait(1).to({scaleX:0.1694},0).wait(1).to({scaleX:0.0863,x:319.95},0).wait(1).to({scaleX:0.0032,x:320},0).wait(1));

	// レイヤー_3
	this.instance_1 = new lib.card();
	this.instance_1.setTransform(320,461.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:0.2,x:320.2,y:455.95},0).wait(1).to({y:450.6},0).wait(1).to({y:445.3},0).wait(1).to({y:439.95},0).wait(1).to({y:434.6},0).wait(1).to({y:429.3},0).wait(1).to({y:423.95},0).wait(1).to({y:418.6},0).wait(1).to({y:413.3},0).wait(1).to({y:407.95},0).wait(1).to({y:402.6},0).wait(1).to({y:397.3},0).wait(1).to({y:391.95},0).wait(1).to({y:386.6},0).wait(1).to({y:381.3},0).wait(1).to({y:375.95},0).wait(1).to({y:370.6},0).wait(1).to({y:365.3},0).wait(1).to({y:359.95},0).wait(1).to({y:354.6},0).wait(1).to({y:349.3},0).wait(1).to({y:343.95},0).wait(1).to({y:338.6},0).wait(1).to({y:333.3},0).wait(1).to({_off:true},1).wait(65));

	// レイヤー_4_コピー_コピー_コピー_コピー_コピー_コピー
	this.instance_2 = new lib.a();
	this.instance_2.setTransform(875.3,278.7,0.7675,0.7675,0,0,180,-72.7,419.3);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(43).to({_off:false},0).to({_off:true},32).wait(16));

	// レイヤー_5_コピー_コピー_コピー_コピー_コピー
	this.instance_3 = new lib.b();
	this.instance_3.setTransform(675.1,283.35,0.6667,0.6667,0,0,0,-86,413.3);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(41).to({_off:false},0).to({_off:true},34).wait(16));

	// レイヤー_5_コピー_コピー_コピー_コピー
	this.instance_4 = new lib.b();
	this.instance_4.setTransform(792.35,357.15,0.6667,0.6667,0,0,0,-86,413.3);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(41).to({_off:false},0).to({_off:true},34).wait(16));

	// レイヤー_4_コピー_コピー_コピー_コピー_コピー
	this.instance_5 = new lib.a();
	this.instance_5.setTransform(688.8,662,0.7493,0.7493,0,0,180,-72.7,419.3);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(43).to({_off:false},0).to({_off:true},32).wait(16));

	// レイヤー_4_コピー_コピー_コピー_コピー_コピー
	this.instance_6 = new lib.a();
	this.instance_6.setTransform(848.1,536.65,0.8371,0.8371,0,0,180,-72.5,419.2);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(41).to({_off:false},0).to({_off:true},34).wait(16));

	// レイヤー_4_コピー_コピー_コピー_コピー
	this.instance_7 = new lib.a();
	this.instance_7.setTransform(705.9,457.4,0.87,0.87,0,0,180,-72.5,419.2);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(41).to({_off:false},0).to({_off:true},34).wait(16));

	// レイヤー_5_コピー_コピー_コピー
	this.instance_8 = new lib.b();
	this.instance_8.setTransform(744.55,573.65,1,1,0,0,180,-86,413.4);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(41).to({_off:false},0).to({_off:true},34).wait(16));

	// レイヤー_4_コピー_コピー_コピー_コピー_コピー
	this.instance_9 = new lib.a();
	this.instance_9.setTransform(-159.4,367.45,0.7675,0.7675,0,0,0,-72.7,419.3);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(43).to({_off:false},0).to({_off:true},32).wait(16));

	// レイヤー_5_コピー_コピー_コピー_コピー
	this.instance_10 = new lib.b();
	this.instance_10.setTransform(-24.8,263.05,0.6667,0.6667,0,0,180,-86,413.3);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(45).to({_off:false},0).to({_off:true},30).wait(16));

	// レイヤー_5_コピー_コピー_コピー_コピー
	this.instance_11 = new lib.b();
	this.instance_11.setTransform(-180.8,278.6,0.6667,0.6667,0,0,180,-86,413.3);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(42).to({_off:false},0).to({_off:true},33).wait(16));

	// レイヤー_5_コピー_コピー_コピー
	this.instance_12 = new lib.b();
	this.instance_12.setTransform(-63.2,241.45,0.6667,0.6667,0,0,180,-86,413.3);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(41).to({_off:false},0).to({_off:true},33).wait(17));

	// レイヤー_4_コピー_コピー_コピー_コピー_コピー
	this.instance_13 = new lib.a();
	this.instance_13.setTransform(-126.4,388,0.8765,0.8765,0,0,0,-72.5,419.2);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(39).to({_off:false},0).to({_off:true},35).wait(17));

	// レイヤー_4_コピー_コピー_コピー_コピー
	this.instance_14 = new lib.a();
	this.instance_14.setTransform(-193.65,542.85,0.8765,0.8765,0,0,0,-72.5,419.2);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(39).to({_off:false},0).to({_off:true},35).wait(17));

	// レイヤー_4_コピー_コピー_コピー
	this.instance_15 = new lib.a();
	this.instance_15.setTransform(-139.3,170.4,1,1,0,0,0,-72.5,419.2);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(37).to({_off:false},0).to({_off:true},35).wait(19));

	// レイヤー_5_コピー_コピー
	this.instance_16 = new lib.b();
	this.instance_16.setTransform(-26.85,509.8,1,1,0,0,0,-86,413.4);
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(37).to({_off:false},0).to({_off:true},35).wait(19));

	// レイヤー_4_コピー_コピー_コピー_コピー_コピー
	this.instance_17 = new lib.a();
	this.instance_17.setTransform(895.6,463.7,0.7675,0.7675,0,0,180,-72.7,419.3);
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(43).to({_off:false},0).to({_off:true},32).wait(16));

	// レイヤー_5_コピー_コピー_コピー_コピー
	this.instance_18 = new lib.b();
	this.instance_18.setTransform(675.1,335.9,0.6667,0.6667,0,0,0,-86,413.3);
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(41).to({_off:false},0).to({_off:true},34).wait(16));

	// レイヤー_5_コピー_コピー_コピー
	this.instance_19 = new lib.b();
	this.instance_19.setTransform(850.05,376.5,0.6667,0.6667,0,0,0,-86,413.3);
	this.instance_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(41).to({_off:false},0).to({_off:true},34).wait(16));

	// レイヤー_4_コピー_コピー_コピー_コピー
	this.instance_20 = new lib.a();
	this.instance_20.setTransform(813.75,681.15,0.8765,0.8765,0,0,180,-72.5,419.2);
	this.instance_20._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(43).to({_off:false},0).to({_off:true},32).wait(16));

	// レイヤー_4_コピー_コピー_コピー_コピー
	this.instance_21 = new lib.a();
	this.instance_21.setTransform(759.65,564.1,1,1,0,0,180,-72.5,419.2);
	this.instance_21._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(41).to({_off:false},0).to({_off:true},34).wait(16));

	// レイヤー_4_コピー_コピー_コピー
	this.instance_22 = new lib.a();
	this.instance_22.setTransform(743.7,426.15,1,1,0,0,180,-72.5,419.2);
	this.instance_22._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(41).to({_off:false},0).to({_off:true},34).wait(16));

	// レイヤー_5_コピー_コピー
	this.instance_23 = new lib.b();
	this.instance_23.setTransform(665.1,609.35,1,1,0,0,180,-86,413.4);
	this.instance_23._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(41).to({_off:false},0).to({_off:true},34).wait(16));

	// レイヤー_4_コピー_コピー_コピー_コピー
	this.instance_24 = new lib.a();
	this.instance_24.setTransform(-248.65,273.25,0.7675,0.7675,0,0,0,-72.7,419.3);
	this.instance_24._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(43).to({_off:false},0).to({_off:true},32).wait(16));

	// レイヤー_5_コピー_コピー_コピー
	this.instance_25 = new lib.b();
	this.instance_25.setTransform(-135.8,129.35,0.6667,0.6667,0,0,180,-86,413.3);
	this.instance_25._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(45).to({_off:false},0).to({_off:true},30).wait(16));

	// レイヤー_5_コピー_コピー_コピー
	this.instance_26 = new lib.b();
	this.instance_26.setTransform(-44.55,179.25,0.6667,0.6667,0,0,180,-86,413.3);
	this.instance_26._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(42).to({_off:false},0).to({_off:true},33).wait(16));

	// レイヤー_5_コピー_コピー
	this.instance_27 = new lib.b();
	this.instance_27.setTransform(-110.7,189.25,0.6667,0.6667,0,0,180,-86,413.3);
	this.instance_27._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(41).to({_off:false},0).to({_off:true},33).wait(17));

	// レイヤー_4_コピー_コピー_コピー_コピー
	this.instance_28 = new lib.a();
	this.instance_28.setTransform(-161.95,304.75,0.8765,0.8765,0,0,0,-72.5,419.2);
	this.instance_28._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(39).to({_off:false},0).to({_off:true},35).wait(17));

	// レイヤー_4_コピー_コピー_コピー
	this.instance_29 = new lib.a();
	this.instance_29.setTransform(-193.65,208.75,0.8765,0.8765,0,0,0,-72.5,419.2);
	this.instance_29._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(39).to({_off:false},0).to({_off:true},35).wait(17));

	// レイヤー_4_コピー_コピー
	this.instance_30 = new lib.a();
	this.instance_30.setTransform(-139.3,232.6,1,1,0,0,0,-72.5,419.2);
	this.instance_30._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_30).wait(37).to({_off:false},0).to({_off:true},35).wait(19));

	// レイヤー_5_コピー
	this.instance_31 = new lib.b();
	this.instance_31.setTransform(-46.6,312.5,1,1,0,0,0,-86,413.4);
	this.instance_31._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_31).wait(37).to({_off:false},0).to({_off:true},35).wait(19));

	// レイヤー_4_コピー_コピー_コピー_コピー
	this.instance_32 = new lib.a();
	this.instance_32.setTransform(836.7,226.15,0.7675,0.7675,0,0,180,-72.7,419.3);
	this.instance_32._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_32).wait(25).to({_off:false},0).to({_off:true},32).wait(34));

	// レイヤー_5_コピー_コピー_コピー
	this.instance_33 = new lib.b();
	this.instance_33.setTransform(689.7,199.65,0.6667,0.6667,0,0,0,-86,413.3);
	this.instance_33._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_33).wait(23).to({_off:false},0).to({_off:true},34).wait(34));

	// レイヤー_5_コピー_コピー
	this.instance_34 = new lib.b();
	this.instance_34.setTransform(762.5,273.45,0.6667,0.6667,0,0,0,-86,413.3);
	this.instance_34._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_34).wait(23).to({_off:false},0).to({_off:true},34).wait(34));

	// レイヤー_4_コピー_コピー_コピー
	this.instance_35 = new lib.a();
	this.instance_35.setTransform(791.15,457.6,0.8765,0.8765,0,0,180,-72.5,419.2);
	this.instance_35._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_35).wait(25).to({_off:false},0).to({_off:true},32).wait(34));

	// レイヤー_4_コピー_コピー_コピー
	this.instance_36 = new lib.a();
	this.instance_36.setTransform(792.35,381.15,1,1,0,0,180,-72.5,419.2);
	this.instance_36._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_36).wait(23).to({_off:false},0).to({_off:true},34).wait(34));

	// レイヤー_4_コピー_コピー
	this.instance_37 = new lib.a();
	this.instance_37.setTransform(765.5,274.5,1,1,0,0,180,-72.5,419.2);
	this.instance_37._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_37).wait(23).to({_off:false},0).to({_off:true},34).wait(34));

	// レイヤー_5_コピー
	this.instance_38 = new lib.b();
	this.instance_38.setTransform(699.8,354.4,1,1,0,0,180,-86,413.4);
	this.instance_38._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_38).wait(23).to({_off:false},0).to({_off:true},34).wait(34));

	// レイヤー_4_コピー_コピー_コピー
	this.instance_39 = new lib.a();
	this.instance_39.setTransform(-263.3,539.85,0.7675,0.7675,0,0,0,-72.7,419.3);
	this.instance_39._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_39).wait(25).to({_off:false},0).to({_off:true},32).wait(34));

	// レイヤー_5_コピー_コピー
	this.instance_40 = new lib.b();
	this.instance_40.setTransform(-150.45,297.35,0.6667,0.6667,0,0,180,-86,413.3);
	this.instance_40._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_40).wait(27).to({_off:false},0).to({_off:true},30).wait(34));

	// レイヤー_5_コピー_コピー
	this.instance_41 = new lib.b();
	this.instance_41.setTransform(-71.25,347.25,0.6667,0.6667,0,0,180,-86,413.3);
	this.instance_41._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_41).wait(24).to({_off:false},0).to({_off:true},33).wait(34));

	// レイヤー_5_コピー
	this.instance_42 = new lib.b();
	this.instance_42.setTransform(-126.45,446.6,0.6667,0.6667,0,0,180,-86,413.3);
	this.instance_42._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_42).wait(23).to({_off:false},0).to({_off:true},33).wait(35));

	// レイヤー_4_コピー_コピー_コピー
	this.instance_43 = new lib.a();
	this.instance_43.setTransform(-80.05,654.95,0.8765,0.8765,0,0,0,-72.5,419.2);
	this.instance_43._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_43).wait(21).to({_off:false},0).to({_off:true},35).wait(35));

	// レイヤー_4_コピー_コピー
	this.instance_44 = new lib.a();
	this.instance_44.setTransform(-161.95,630.75,0.8765,0.8765,0,0,0,-72.5,419.2);
	this.instance_44._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_44).wait(21).to({_off:false},0).to({_off:true},35).wait(35));

	// レイヤー_4_コピー
	this.instance_45 = new lib.a();
	this.instance_45.setTransform(-153.95,447.65,1,1,0,0,0,-72.5,419.2);
	this.instance_45._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_45).wait(19).to({_off:false},0).to({_off:true},35).wait(37));

	// レイヤー_5
	this.instance_46 = new lib.b();
	this.instance_46.setTransform(-61.25,527.55,1,1,0,0,0,-86,413.4);
	this.instance_46._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_46).wait(19).to({_off:false},0).to({_off:true},35).wait(37));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(39.4,492.5,873.6,237);
// library properties:
lib.properties = {
	id: 'F345FB024BDA3C4D84D35276F38066C6',
	width: 640,
	height: 800,
	fps: 60,
	color: "#999999",
	opacity: 1.00,
	manifest: [
		{src:"./effectcjs/clear_2/images/clear_card2.png", id:"clear_card2"},
		{src:"./effectcjs/clear_2/images/clear_card_back.png", id:"clear_card_back"}
	],
	preloads: []
};
...
an.compositions['F345FB024BDA3C4D84D35276F38066C6'] = {
