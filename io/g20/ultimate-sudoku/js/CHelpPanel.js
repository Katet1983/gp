function CHelpPanel(){
    ...
    this._init = function(){
        ...
        _oText0 = new createjs.Text(TEXT_HELP0," 140px " +SECONDARY_FONT, PRIMARY_FONT_COLOUR);
        ...
        _oText1 = new createjs.Text(TEXT_HELP1," 50px " +PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        ...
        _oText0Page2 = new createjs.Text(TEXT_HELP0_PAGE2," 140px " +SECONDARY_FONT, PRIMARY_FONT_COLOUR);
        ...
        _oText1Page2 = new createjs.Text(_oMessage," 35px " +PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        ...
        _oText2Page2 = new createjs.Text(TEXT_HELP2_PAGE2," 35px " +PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        ...
        _oText3Page2 = new createjs.Text(TEXT_HELP3_PAGE2," 35px " +PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        ...
        _oText4Page2 = new createjs.Text(TEXT_HELP4_PAGE2," 35px " +PRIMARY_FONT, PRIMARY_FONT_COLOUR);
