function CModeMenu(){
    ...
    this._init = function(){
        ...
        _oTextTop = new createjs.Text(TEXT_TOP_MODE," 100px " +SECONDARY_FONT, PRIMARY_FONT_COLOUR);
        ...
        _oTextEasy = new createjs.Text(TEXT_EASY," 50px " +SECONDARY_FONT, PRIMARY_FONT_COLOUR);
	_oTextEasy.textBaseline = "alphabetic";
        ...
        _oTextMedium = new createjs.Text(TEXT_MEDIUM," 50px " +SECONDARY_FONT, PRIMARY_FONT_COLOUR);
        ...
        _oTextHard = new createjs.Text(TEXT_HARD," 50px " +SECONDARY_FONT, PRIMARY_FONT_COLOUR);
