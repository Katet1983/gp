function CInterface(){
    ...
    this._init = function(){                
        ...
        _oTimeText = new createjs.Text(TEXT_TIME,"bold 60px " +PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        _oTimeText.x = 40;
        _oTimeText.y = 325;
        ...
        _oTimeNum = new createjs.Text("00:00","bold 60px " +PRIMARY_FONT, "#ffffff");
        _oTimeNum.x = 245;
        _oTimeNum.y = 325;
    ...
    this._onExit = function(){
        s_oGame.pauseTimer(true);
        _oAreYouSurePanel = new CAreYouSurePanel(s_oInterface._onConfirmExit, s_oInterface._onNegateExit);
    };
